...
package com.orange.discobole.productinventory.customAnnotator;
...
public class LombokAnnotator extends AbstractAnnotator {
    ...
    public void propertyInclusion(
        ...
        if (superClassTitle != null
                && ("BaseEvent".equals(superClassTitle.asText())
                || "Command".equals(superClassTitle.asText()))) {
