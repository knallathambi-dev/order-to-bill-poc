<!--
Software Name: disco-product-inventorylab-profile
...
# Product Inventory (CPIB) Component

Responsible for storage and exposure of products that are assigned to and used by parties.
...
Then clone all repositories of `disco-product-inventory`, as follows:

```bash
git-all clone discobole/disco-oda-components/disco-product-inventory
```
