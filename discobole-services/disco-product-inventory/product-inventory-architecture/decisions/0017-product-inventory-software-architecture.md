...
* for event bus [ this need a collective decision from the DISCO group - (a POC is in progress : Kafka Implementation for wrapping Kafka for event bus specification
