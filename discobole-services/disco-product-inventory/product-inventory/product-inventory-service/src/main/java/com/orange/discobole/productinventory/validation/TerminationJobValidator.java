...
@Slf4j
public class TerminationJobValidator {
    private TerminationJobValidator() {
    }
    ...
    public static boolean isCreationObjectValid(JobSpecification jobSpecification) {
        ...
        return JobSpecificationType.TERMINATIONJOBSPECIFICATION.getValue().equals(jobSpecification.getAtType()) && isImmediateOrOneTimeJobScheduler;
    }
}
