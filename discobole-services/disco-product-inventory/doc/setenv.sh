...
function parse_params() {
  ...
  do
    ...
    case $key in
        ...
        log_info "       [--test <catalog|cpib|om|cood|security|ui|event>   test with ODACAT component]"
  ...
  export TRACE API_URL CI_COMMIT_TAG
...
function setup_mkdocs() {
  ...
  if [[ "$TEST" == "catalog" ]] || [[ "$TEST" == "odacat" ]]; then  
    GITLAB_GROUPS='
    [
      {   
        ...
        "doc": "https://discobole.ow2.io/disco-oda-components/disco-product-inventory/doc/"
      } 
    ]'
  fi
