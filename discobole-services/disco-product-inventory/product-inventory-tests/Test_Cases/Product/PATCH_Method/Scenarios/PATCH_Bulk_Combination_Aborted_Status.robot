...
Valid_Patch_with_All Children Terminated
    ...
    patch_status                                ${Product_id}[1]                    Created                         Confirmed
    patch_status                                ${Product_id}[1]                    Created                         PendingActive
    patch_status                                ${Product_id}[1]                    Aborted                         Aborted
    patch_status                                ${Product_id}[0]                    Created                         Confirmed
    patch_status                                ${Product_id}[0]                    Created                         PendingActive
    patch_status                                ${Product_id}[0]                    Aborted                         Aborted
...
Valid_Patch_with_All_Children_Cancelled_Operational_Status_Confirmed_toPendingActive_toLocked_toAborted
    ...
    patch_status                        ${Product_id}[1]                        Created                         Confirmed
    patch_status                        ${Product_id}[1]                        Created                         PendingActive
    patch_status                        ${Product_id}[1]                        Created                         Locked
    patch_status                        ${Product_id}[1]                        Aborted                         Aborted
    patch_status                        ${Product_id}[0]                        Created                         Confirmed
    patch_status                        ${Product_id}[0]                        Created                         PendingActive
    patch_status                        ${Product_id}[0]                        Created                         Locked
    patch_status                        ${Product_id}[0]                        Aborted                         Aborted
    valid_aborted_status                ${product_id}[0]                        Aborted                         Aborted                ${Product_id}[1]
    log                                 ${Product_id}[0]
