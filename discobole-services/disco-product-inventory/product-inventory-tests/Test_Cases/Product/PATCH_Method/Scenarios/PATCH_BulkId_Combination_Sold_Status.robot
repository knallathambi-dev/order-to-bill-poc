...
Valid_Patch_Sold_with_Created_operationalStatus_for_ShipmentProduct
    ...
    patch_product_by_id_with_statuses                                 ${Product_id1}[1]                        ShipmentProduct       Sold                           Sold
    log     ${Product_id1}[1]

Valid_Patch_Sold_with_Confirmed_operationalStatus_for_PhysicalProduct
    Get_token
    ${product_id}                   Post_valid_physical          Post_body_request_for_physical_product
    patch_product_by_id_with_statuses                    ${product_id}[3]             PhysicalProduct   Created       Confirmed
    patch_product_by_id_with_statuses                    ${product_id}[3]             PhysicalProduct   Sold          Sold
...
Valid_Patch_Sold_with_Confirmed_operationalStatus_for_ShipmentProduct
    ...
    patch_with_reliesOn_reliesFrom              ${Product_id1}[1]                        ${Product_id2}[3]
    patch_product_by_id_with_statuses                                ${product_id1}[1]                        ShipmentProduct       Created                        Confirmed
    patch_product_by_id_with_statuses                                ${Product_id1}[1]                        ShipmentProduct       Sold                           Sold
    log                                         ${Product_id1}[1]
...
Invalid_Patch_Sold_for_PhysicalProduct
    Get_token
    ${product_id}                   Post_valid_physical          Post_body_request_for_physical_product
    invalid_patch_product_by_id_with_statuses            ${product_id}[2]             Sold          Sold
...
Invalid_Patch_Sold_for_ShipmentProduct
    ...
    log         ${Product_id}[1]
    Log         ${Product_id2}[3]
    invalid_patch_product_by_id_with_statuses                        ${product_id}[0]                         Sold                           Sold
