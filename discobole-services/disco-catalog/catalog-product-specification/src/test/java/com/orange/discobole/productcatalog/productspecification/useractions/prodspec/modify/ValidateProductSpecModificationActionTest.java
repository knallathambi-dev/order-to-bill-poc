...
public class ValidateProductSpecModificationActionTest extends ProductSpecificationApplicationTests {

	@InjectMocks
	private ValidateProductSpecModificationAction userAction;
	...
	void performProductOfferingValidationWhenUserClicksOnValidate() {
		...
		assertThat(performVariables.size()).isEqualTo(1);
	}
