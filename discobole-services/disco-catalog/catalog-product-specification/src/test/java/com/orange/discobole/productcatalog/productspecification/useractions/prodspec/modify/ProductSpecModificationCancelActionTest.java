...
public class ProductSpecModificationCancelActionTest extends ProductSpecificationApplicationTests {

	@InjectMocks
	private ProductSpecModificationCancelAction productSpecCancelAction;
	...
	void performTest() {
		...
		Mockito.verify(productSpecService, Mockito.times(1)).cancelProductSpecModification(PRODUCT_SPC_ID);
