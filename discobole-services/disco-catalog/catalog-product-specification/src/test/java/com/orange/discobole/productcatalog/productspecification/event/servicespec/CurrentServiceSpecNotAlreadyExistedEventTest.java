...
class CurrentServiceSpecNotAlreadyExistedEventTest {
    ...
    void serviceSpecNotAlreadyExistTest(){
        CurrentServiceSpecNotAlreadyExistedEvent currentServiceSpecNotAlreadyExistedEvent = new CurrentServiceSpecNotAlreadyExistedEvent(
                serviceSpecification);
        Assertions.assertEquals(serviceSpecification, currentServiceSpecNotAlreadyExistedEvent.getServiceSpecification());
    }
}
