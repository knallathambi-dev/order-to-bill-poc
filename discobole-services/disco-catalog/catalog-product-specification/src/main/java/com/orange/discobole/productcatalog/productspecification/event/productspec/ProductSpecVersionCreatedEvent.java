...
/**
 * The Class ProductSpecVersionCreatedEvent stores the created version of
...
public final class ProductSpecVersionCreatedEvent implements ProductSpecEvent {
	...
	private ProductSpecVersionCreatedEvent() {
	...
	public String toString() {
		return "ProductSpecVersionCreatedEvent [" + "productSpecificationId=" + productSpecificationId
				+ ", productSpecificationVersion=" + productSpecificationVersion + ", lastUpdate=" + lastUpdate + "]";
	}
}
