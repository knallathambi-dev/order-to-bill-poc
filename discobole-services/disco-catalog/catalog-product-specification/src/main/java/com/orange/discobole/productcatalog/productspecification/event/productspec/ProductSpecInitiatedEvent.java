...
public final class ProductSpecInitiatedEvent implements ProductSpecEvent {
	...
	/** Constructor for ProductSpecInitiatedEvent
	 * 
	 * @param productSpecId generated product spec id
	 * @param resourceState the state of resourceState
	 * @param supportEntity type of support entity
	 * @param serviceSpecificationRef reference of service spec on which product spec is created
	 * @param lastUpdate when the event is generated
	 */
	...
	public String toString() {
		return "ProductSpecInitiatedEvent [productSpecId=" + productSpecId + ", resourceState=" + resourceState
				+ ", supportEntity=" + supportEntity + ", serviceSpecificationRef=" + serviceSpecificationRef
				+ ", lastUpdate=" + lastUpdate + ", stockItemType=" + stockItemType + ", baseType=" +baseType +"]";
	}
