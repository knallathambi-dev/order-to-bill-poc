...
@Component("ProductSpecModification.modifyRelationship")
public class ModifyRelationshipAction implements UserAction {
	...
	public Map<String, Object> perform(StateMachineTransition stateMachineTransition, TaskFlowUpdate taskFlowUpdate)
		...
		productSpecService.modifyProductSpecRel(productSpecId, relationships, policyRules);
