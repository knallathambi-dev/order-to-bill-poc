...
package com.orange.discobole.productcatalog.productspecification.dto.generated;
...
public class Event {
	...
	public String toString() {
		return "Event{" + "eventId='" + eventId + '\'' + ", eventType='" + eventType + '\'' + ", eventTime=" + eventTime
				+ ", correlationId='" + correlationId + '\'' + ", description='" + description + '\'' + ", domain='"
				+ domain + '\'' + ", priority='" + priority + '\'' + ", timeOcurred=" + timeOcurred + ", title='"
				+ title + '\'' + ", analyticCharacteristic=" + analyticCharacteristic + ", event=" + event
				+ ", relatedParty=" + relatedParty + ", reportingSystem=" + reportingSystem + ", source=" + source
				+ ", baseType='" + baseType + '\'' + ", schemaLocation='" + schemaLocation + '\'' + ", type='" + type
				+ '\'' + '}';
	}
}
