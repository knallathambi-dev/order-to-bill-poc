...
public class CreateJsonFromPOJO {
	...
	private static final String SLASHUSEDINURL = "/";
	...
	public static void main(String []args) throws IOException {
		...
		Reflections reflections = new Reflections("com.orange.discobole.productcatalog.productspecification.pojo",
		...
		for (Class<?> type : allClasses) {
			...
			try {
				...
				if ("com.orange.discobole.productcatalog.productspecification.pojo".equals(packageName)) {
					...
					writer.writeValue(new File(
							"./src/main/resources/schemas/" + packageList + SLASHUSEDINURL + type.getSimpleName() + ".json"),
							nextTask);
				}
