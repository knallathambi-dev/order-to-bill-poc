...
public enum ResourceState {
	 ...
	 * value provided.
	 *
	 * @param resourceState string representation of value of resource state
	 * @return returns the lifecycle state in {@code ResourceState} enum format
	 */
	public static ResourceState fromValue(String resourceState) {
		for (ResourceState b : ResourceState.values())
			if (String.valueOf(b.resourceState).equals(resourceState))
				return b;
		return null;
	}
	...
	public String toString() {
		return String.valueOf(resourceState);
	}
}
