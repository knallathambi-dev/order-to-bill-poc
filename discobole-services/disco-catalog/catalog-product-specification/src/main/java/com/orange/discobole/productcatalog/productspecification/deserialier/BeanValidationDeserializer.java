...
package com.orange.discobole.productcatalog.productspecification.deserialier;
...
public class BeanValidationDeserializer extends BeanDeserializer {
    ...
    private void validate(Object instance) {
        ...
        if (violations.size() > 0) {
            ...
            msg.append("JSON object is not valid. ");
            for (ConstraintViolation<Object> violation : violations) {
               msg.append(violation.getPropertyPath()).append(" ").append(violation.getMessage());
            }
