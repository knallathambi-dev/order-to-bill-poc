...
public class ModifyProductSpecCharacteristicCommand {
	...
	public ModifyProductSpecCharacteristicCommand(String productSpecId,List<ProductSpecificationCharacteristic> productSpecCharacteristics, List<UsageSpecification> usageSpecifications) {
	...
	public String toString() {
		return "ModifyProductSpecCharacteristicCommand{productSpecId=" + productSpecId + ", productSpecCharacteristics="
				+ productSpecCharacteristics + ", usageSpecifications=" + usageSpecifications+ '}';
	}
}
