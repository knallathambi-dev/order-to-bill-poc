...
public class ConfigurableProperties {
	...
	public String getCfsrelationshipUrl() {
		return cfsrelationshipUrl;
	}

	public void setCfsrelationshipUrl(String cfsrelationshipUrl) {
		this.cfsrelationshipUrl = cfsrelationshipUrl;
	}
	...
	private  String cfsrelationshipUrl;
