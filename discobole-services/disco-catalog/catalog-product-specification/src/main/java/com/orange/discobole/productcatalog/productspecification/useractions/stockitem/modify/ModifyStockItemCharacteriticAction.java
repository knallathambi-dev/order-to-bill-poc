...
package com.orange.discobole.productcatalog.productspecification.useractions.stockitem.modify;
 ...
 * @since 1.0
 */
@Component("ProductSpecModification.modifyStockCharacteristics")
public class ModifyStockItemCharacteriticAction implements UserAction {
    ...
    public Map<String, Object> perform(StateMachineTransition stateMachineTransition, TaskFlowUpdate taskFlowUpdate)
        ...
        productSpecService.modifyStockItemProductSpecCharacteristics(productSpecId, prodSpecCharacteristics);
    ...
    private void createCharacteristicSpecification(Characteristic characteristic,
        ...
        for (PickStockCharacteristicSpecification pickStockCharacteristicSpecification : charSpec) {
			...
			productSpecificationCharacteristic.id(pickStockCharacteristicSpecification.getId())
					.name(pickStockCharacteristicSpecification.getName())
					.description(pickStockCharacteristicSpecification.getDescription())
					.validFor(TimePeriodMapper.toGenerated(pickStockCharacteristicSpecification.getValidFor()))
					.configurable(pickStockCharacteristicSpecification.getConfigurable())
					.isUnique(pickStockCharacteristicSpecification.getIsUnique())
