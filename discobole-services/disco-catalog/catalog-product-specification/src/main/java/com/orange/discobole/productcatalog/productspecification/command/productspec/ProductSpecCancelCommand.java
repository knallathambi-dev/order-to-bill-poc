 ...
 * @since 1.0
 */
public final class ProductSpecCancelCommand {
     ...
     */
    public ProductSpecCancelCommand(String productSpecId) {
        this.productSpecId = productSpecId;
    }

	@Override
	public String toString() {
		return "ProductSpecCancelCommand{" + "productSpecId='" + productSpecId + '}';
	}

    /**
     * This method is used to return the productSpecId associated with
     * {@link ProductSpecCancelCommand}
     *
