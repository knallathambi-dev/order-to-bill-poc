...
public class CharacteristicValueSpecification {
	...
	@Override
	public int hashCode() {
		return Objects.hash(isDefault, rangeInterval, regex, timeRange, unitOfMeasure, validFor, value, valueFrom, valueTo,
				valueType, baseType, schemaLocation, type, addressId, subUnitNumber, streetName, postcode, city, country);
	}
