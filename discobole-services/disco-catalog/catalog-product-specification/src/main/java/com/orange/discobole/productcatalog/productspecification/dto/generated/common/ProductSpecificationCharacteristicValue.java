...
public class ProductSpecificationCharacteristicValue {
	...
	public ProductSpecificationCharacteristicValue isSelectable(Boolean isSelectable) {
		this.isSelectable = isSelectable;
		return this;
	}

	/**
	 * Indicates if the value is the selectable value for a characteristic
	 * 
	 * @return isSelectable
	 **/
	@ApiModelProperty(value = "Indicates if the value is the selectable value for a characteristic")
	...
	public ProductSpecificationCharacteristicValue timeRange(TimeRange timeRange) {
	...
	public ProductSpecificationCharacteristicValue value(String value) {
		this.value = value;
		return this;
	}
	...
	public ProductSpecificationCharacteristicValue characteristicReferenceValue(String characteristicReferenceValue) {
		this.characteristicReferenceValue = characteristicReferenceValue;
		return this;
	}

	/**
	 * Reference of the value of the characteristic
	 *
	 * @return baseType
	 **/
	@ApiModelProperty(value = "Reference of the value of the support entity characteristic")
	...
	public ProductSpecificationCharacteristicValue addressId(String addressId) {
		this.addressId = addressId;
		return this;
	}

	@Schema(description = "A String. Unique identifier")
	...
	public ProductSpecificationCharacteristicValue subUnitNumber(String subUnitNumber) {
		this.subUnitNumber = subUnitNumber;
		return this;
	}

	@Schema(description = "A String. The discriminator used for the subunit, often just a simple number but may also be a range.")
	...
	public ProductSpecificationCharacteristicValue streetName(String streetName) {
		this.streetName = streetName;
		return this;
	}

	@Schema(description = "A String. Private streets internal to a property (e.g. a university) may have internal names that are not recorded by the land title office.")
	...
	public ProductSpecificationCharacteristicValue postcode(String postcode) {
		this.postcode = postcode;
		return this;
	}

	@Schema(description = "Descriptor for a postal delivery area, used to speed and simplify the delivery of mail (also know as zipcode)")
	...
	@Schema(description = "A String. City that the address is in.")
	...
	public ProductSpecificationCharacteristicValue city(String city) {
		this.city = city;
		return this;
	}

	public ProductSpecificationCharacteristicValue country(String country) {
		this.country = country;
		return this;
	}

	@Schema(description = "A string. Country that the address is in.")
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(this.isDefault, productSpecificationCharacteristicValue.isDefault)
				...
				&& Objects.equals(this.isSelectable, productSpecificationCharacteristicValue.isSelectable)
				...
				&& Objects.equals(this.characteristicReferenceValue,
						productSpecificationCharacteristicValue.characteristicReferenceValue)
			    ...
			    && Objects.equals(this.addressId, productSpecificationCharacteristicValue.addressId)
				&& Objects.equals(this.subUnitNumber, productSpecificationCharacteristicValue.subUnitNumber)
				&& Objects.equals(this.streetName, productSpecificationCharacteristicValue.streetName)
				&& Objects.equals(this.postcode, productSpecificationCharacteristicValue.postcode)
				&& Objects.equals(this.city, productSpecificationCharacteristicValue.city)
				&& Objects.equals(this.country, productSpecificationCharacteristicValue.country);
	}

	@Override
	public int hashCode() {
		return Objects.hash(isDefault, isSelectable, rangeInterval, regex, unitOfMeasure, valueFrom, valueTo, valueType,
				validFor, value, baseType, schemaLocation, type, characteristicReferenceValue, addressId, subUnitNumber, streetName, postcode, city, country);
	}
	...
	public String toString() {
		...
		sb.append("    characteristicReferenceValue: ").append(toIndentedString(characteristicReferenceValue))
				.append("\n");
