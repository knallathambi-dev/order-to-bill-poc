...
import com.orange.discobole.productcatalog.productspecification.pojo.TimeRange;
...
public class TimeRangeMapper {
	...
	public static TimeRange toPojo(
			com.orange.discobole.productcatalog.productspecification.dto.generated.common.TimeRange timeRange) {
		if (timeRange == null) {
			return null;
		}
	...
	public static com.orange.discobole.productcatalog.productspecification.dto.generated.common.TimeRange toGenerated(
			TimeRange timeRange) {
		if (timeRange == null) {
			return null;
		}
		return new com.orange.discobole.productcatalog.productspecification.dto.generated.common.TimeRange()
