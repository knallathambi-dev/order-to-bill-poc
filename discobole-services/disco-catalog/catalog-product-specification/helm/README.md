...
A Helm chart for the product specification service.
...
```bash
helm install my-release disco-stable-repo/catalog-product-specification
```
...
| services.catprodcaturl | string | `"https://catalog-product-catalog"` | catalog URL |
...
```console
$ helm install my-release -f values.yaml disco-stable-repo/catalog-product-specification
```
