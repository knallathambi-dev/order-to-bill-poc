...
package com.orange.discobole.productcatalog.administration.dto.generated.common;
...
public class UserRole {
    ...
    public UserRole(String id, String involvementRole, String type, List<Entitlement> entitlement) {
        this.id = id;
