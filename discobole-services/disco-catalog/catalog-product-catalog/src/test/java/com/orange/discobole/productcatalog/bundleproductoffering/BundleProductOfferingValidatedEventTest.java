...
class BundleProductOfferingValidatedEventTest extends CatalogApplicationTests {
	...
	void bundleProductOfferingValidatedEventTest() {
		...
		LOGGER.debug("bundleProductOfferingValidatedEvent: {}", bundleProductOfferingValidatedEvent);
	}
}
