...
class BundleProductOfferingVersionCreatedEventTest extends CatalogApplicationTests {
	...
	void setUp() {
		...
		bundleProductOfferingVersionCreatedEvent = new BundleProductOfferingVersionCreatedEvent(productOffId, "1.0.0",
				lastUpdate);
	}
