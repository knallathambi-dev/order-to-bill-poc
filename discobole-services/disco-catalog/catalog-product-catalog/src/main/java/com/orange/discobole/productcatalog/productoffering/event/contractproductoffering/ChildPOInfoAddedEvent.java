...
public class ChildPOInfoAddedEvent implements ContractProductOfferingEvent{
     ...
     */
    public ChildPOInfoAddedEvent(String productOfferingId,List<BundledProductOffering> bundleProductOffering, OffsetDateTime lastUpdate, Integer globalMinCardinality,
