 ...
 *
 */
public final class ContractProductOfferingIdentityDataModifiedEvent implements ContractProductOfferingEvent {
	...
	public ContractProductOfferingIdentityDataModifiedEvent() {
	...
	public ContractProductOfferingIdentityDataModifiedEvent(String productOfferingId,
                                                            ...
                                                            ProductOfferingType type, String statusReason, OffsetDateTime lastUpdate ,ProductOfferingLifecycle lifecycleStatus, ProductOfferingLifecycle currentLifecycleStatus) {
	...
	public String toString() {
		return "ContractProductOfferingIdentityDataModifiedEvent{" +
