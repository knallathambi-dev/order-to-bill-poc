...
public class ModifyProductOfferingAllowedActionDefinedEvent implements ProductOfferingEvent {
	...
	private ModifyProductOfferingAllowedActionDefinedEvent() {
		this.productOfferingId = null;
		this.allowedAction = null;
		this.lastUpdate = null;
	}

	public ModifyProductOfferingAllowedActionDefinedEvent(
	...
	public String toString() {
		return "ModifyProductOfferingAllowedActionDefinedEvent{" +
