...
public class ProductOfferingPriceVersionCreatedEvent implements ProductOfferingPriceEvent {
    ...
    public ProductOfferingPriceVersionCreatedEvent(String productOfferingPriceId, String version, OffsetDateTime lastUpdate) {
    ...
    public String toString() {
        return "ProductOfferingPriceVersionCreatedEvent{" +
