...
public class ProductOfferingPriceRelationshipDefinedEvent implements ProductOfferingPriceEvent {
	...
	private ProductOfferingPriceRelationshipDefinedEvent() {
		this.productOfferingPriceId = null;
		this.productOfferingPriceRelationships = null;
		this.lastUpdate = null;
	}

	public ProductOfferingPriceRelationshipDefinedEvent(String productOfferingPriceId,
