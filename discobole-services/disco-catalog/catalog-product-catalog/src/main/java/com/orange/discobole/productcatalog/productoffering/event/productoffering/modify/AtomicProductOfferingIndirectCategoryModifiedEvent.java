...
public class AtomicProductOfferingIndirectCategoryModifiedEvent implements ProductOfferingEvent {
    ...
    public AtomicProductOfferingIndirectCategoryModifiedEvent(String productOfferingId, Set<CategoryRef> addCategories,
    ...
    public AtomicProductOfferingIndirectCategoryModifiedEvent() {
        super();
