...
import com.orange.discobole.productcatalog.policyrule.dto.Entitlement;
import com.orange.discobole.productcatalog.policyrule.dto.UserRole;
import com.orange.discobole.productcatalog.policyrule.handler.RestTemplateResponseErrorHandler;
import com.orange.discobole.productcatalog.policyrule.interceptor.RestTemplateInterceptor;
...
public class KeycloakGrantedAuthoritiesConverter implements Converter<Jwt, Collection<GrantedAuthority>> {
    ...
    public List<UserRole> fetchUserRoles(String token) {
        String marketUrl = UriComponentsBuilder.fromUriString(userRoleRetrievalUrl).toUriString();
