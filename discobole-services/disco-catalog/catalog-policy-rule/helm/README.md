...
A Helm chart for policy rule service.

**Homepage:** <https://gitlab.ow2.org/discobole>

## Source Code

* <https://gitlab.ow2.org/discobole/disco-oda-components/disco-catalog/catalog-policy-rule>
...
```bash
helm install my-release disco-stable-repo/catalog-policy-rule
```
...
| keycloak.issuerURI | string | `"https://keycloak/realms/SpringBootKeycloak"` | Keycloak  issuer URI |
...
| promtail.enabled | bool | `false` | enable promtail sidecar container |
...
| services.catprodcaturl | string | `"https://catalog-policy-rule"` | catalog's API URL |
...
| services.policyrule | string | `"catalog-policy-rule:8080"` | dependent microservice |
...
```console
$ helm install my-release -f values.yaml disco-stable-repo/catalog-policy-rule
```
