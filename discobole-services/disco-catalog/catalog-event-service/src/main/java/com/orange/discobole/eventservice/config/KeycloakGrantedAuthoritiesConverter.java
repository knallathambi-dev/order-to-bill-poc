...
import com.orange.discobole.eventservice.dto.generated.Entitlement;
import com.orange.discobole.eventservice.dto.generated.UserRole;
import com.orange.discobole.eventservice.exception.RestTemplateResponseErrorHandler;
...
public class KeycloakGrantedAuthoritiesConverter implements Converter<Jwt, Collection<GrantedAuthority>> {
    ...
    public List<UserRole> fetchUserRoles(String token) {
        ...
        List<UserRole> roles = getRestTemplate()
                .exchange(marketUrl, HttpMethod.GET, entity, new ParameterizedTypeReference<List<UserRole>>() {
                }).getBody();
        return roles;
    }
