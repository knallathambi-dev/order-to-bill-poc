...
A Helm chart for the lifecycle management service

**Homepage:** <https://discobole.ow2.io/doc>

## Source Code

* <https://gitlab.ow2.org/discobole/disco-catalog/catalog-product-lifecycle-management/>
...
```bash
helm install my-release disco-stable-repo/catalog-product-lifecycle-management
```
...
| services.administration | string | `"catalog-product-catalog-administration:8080"` | dependent microservice |
...
```console
$ helm install my-release -f values.yaml disco-stable-repo/catalog-product-lifecycle-management
```
