...
import com.orange.discobole.productcatalog.lifecyclemanagement.dto.generated.common.Entitlement;
import com.orange.discobole.productcatalog.lifecyclemanagement.dto.generated.common.UserRole;
import com.orange.discobole.productcatalog.lifecyclemanagement.interceptor.RestTemplateInterceptor;
        ...
        if (resourceAccess != null) {
            for (Map.Entry<String, Object> entry : resourceAccess.entrySet()) {
                ...
                if (clientRoles instanceof Map) {
                    ...
                    List<String> roles = ((Map<?, ?>) clientRoles).containsKey("roles") ? (List<String>) ((Map<?, ?>) clientRoles).get("roles") : null;
                    if (roles!=null){
