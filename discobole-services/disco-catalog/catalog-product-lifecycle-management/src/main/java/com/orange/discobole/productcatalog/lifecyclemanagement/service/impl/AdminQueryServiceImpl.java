...
import com.orange.discobole.productcatalog.lifecyclemanagement.dto.generated.common.CpibConfiguration;
...
public class AdminQueryServiceImpl implements AdminQueryService {
    ...
    @Override
    public boolean fetchCPIBConfiguration(String accessToken) {
        UriComponentsBuilder cpibComponentsBuilder =
                UriComponentsBuilder.fromUriString(configurableProperties.getAdminCPIBConfigUrl());
        if(accessToken == null){
