...
import com.orange.discobole.productcatalog.lifecyclemanagement.dto.generated.common.ProductOfferingPriceAttributeValueChangeEventPayload;
...
public class ProductOfferingPriceAttributeValueChangeEvent {
	...
	public ProductOfferingPriceAttributeValueChangeEvent event(
			ProductOfferingPriceAttributeValueChangeEventPayload event) {
		this.event = event;
		return this;
	}
	...
	@Override
	public int hashCode() {
		return Objects.hash(eventId, eventTime, eventType, correlationId, domain, title, description, priority,
				timeOcurred, fieldPath, event);
	}
