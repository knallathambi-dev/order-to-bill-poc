...
public class CreateJsonFromPOJO {
	...
	public static void main(String[] args) throws IOException {
		...
		Reflections reflections = new Reflections("com.orange.discobole.productcatalog.lifecyclemanagement.pojo",
		...
		for (Class<?> type : allClasses) {
			...
			try {
				...
				if ("com.orange.discobole.productcatalog.lifecyclemanagement.pojo".equals(packageName)) {
