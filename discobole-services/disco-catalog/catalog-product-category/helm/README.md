...
A Helm chart for the category service
...
| promtail.enabled | bool | `false` | enable Promtail sidecar |
| replicaCount | int | `1` | Application replica count |
| resources.resources.limits | object | `{"cpu":"100m","memory":"300Mi"}` | Resource limits |
| resources.resources.requests | object | `{"cpu":"50m","memory":"128Mi"}` | Resource requests  |
...
| services.catprodcaturl | string | `"https://catalog-policy-catalog"` | catalog's API URL |
