 ...
 *
 */
@Component("CategoryCreation.defineEntity")
public class DefineEntityAction implements UserAction {
	...
	public Map<String, Object> perform(StateMachineTransition stateMachine, TaskFlowUpdate taskFlowUpdate)
		...
		categoryService.associateEntity(categoryId,productOfferingIds);
		return variables;
	}
