...
public class CategoryValidateActionTest extends CategoryApplicationTests {
@InjectMocks
private CategoryValidateAction categoryValidateAction;
@Mock
...
void performTest() {
	...
	Mockito.verify(categoryService, Mockito.times(1)).validateCategory(CATEGORY_ID);
