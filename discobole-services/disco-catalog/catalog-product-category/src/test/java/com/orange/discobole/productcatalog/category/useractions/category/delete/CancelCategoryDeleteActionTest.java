 ...
 */
public class CancelCategoryDeleteActionTest extends CategoryApplicationTests {
    @InjectMocks
    private CancelCategoryDeleteAction cancelCategoryDeleteAction;
    @Mock
    ...
    public void init() throws JsonMappingException, JsonProcessingException, JSONException, Exception {
        ...
        ReflectionTestUtils.setField(cancelCategoryDeleteAction, "objectMapper", objectMapper);
        cancelCategoryDeleteAction.init();
    }
    ...
    void performTest() {
        ...
        cancelCategoryDeleteAction.perform(stateMachineTransition, taskFlowUpdate);
        Mockito.verify(deleteCategoryService, Mockito.times(1)).cancelCategoryDeletion(CATEGORY_ID);
    }

    @Test
    void requiredCharacteristicsTest() {
        cancelCategoryDeleteAction.requiredCharacteristics(stateMachineTransition, null);
        List<CharacteristicSpecification> list= cancelCategoryDeleteAction.requiredCharacteristics(stateMachineTransition, null); 
   	 assertNotNull(list);
    }
}
