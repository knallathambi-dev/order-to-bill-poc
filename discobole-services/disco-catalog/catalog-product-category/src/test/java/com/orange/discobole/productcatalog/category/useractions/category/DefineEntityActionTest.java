...
public class DefineEntityActionTest extends CategoryApplicationTests {

@InjectMocks
private DefineEntityAction defineEntityAction;
...
public void init() throws JsonMappingException, JsonProcessingException, JSONException, Exception {
	...
	ReflectionTestUtils.setField(defineEntityAction, "objectMapper", objectMapper);
	defineEntityAction.init();
}
@Test
public void performTest() {
	...
	Map<String, Object> performVariables =defineEntityAction.perform(stateMachineTransition, taskFlowUpdate); 
...
void requiredCharacteristicsTest() {
	defineEntityAction.requiredCharacteristics(stateMachineTransition, null);
	List<CharacteristicSpecification> list= defineEntityAction.requiredCharacteristics(stateMachineTransition, null); 
	 assertNotNull(list);
