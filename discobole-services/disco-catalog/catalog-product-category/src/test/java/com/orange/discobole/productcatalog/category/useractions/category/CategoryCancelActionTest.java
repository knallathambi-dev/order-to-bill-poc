...
public class CategoryCancelActionTest extends CategoryApplicationTests {
@InjectMocks
private CategoryCancelAction categoryCancelAction;
@Mock
...
void performTest() {
	...
	Mockito.verify(categoryService, Mockito.times(1)).cancelCategory(CATEGORY_ID);
