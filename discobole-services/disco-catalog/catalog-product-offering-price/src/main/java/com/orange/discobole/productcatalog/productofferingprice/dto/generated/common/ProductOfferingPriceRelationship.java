...
public class ProductOfferingPriceRelationship {
	 ...
	 * @return id
	 **/
	@Schema(defaultValue  = "Unique identifier of the associated product offering price")
	public String getId() {
		return id;
	}
	 ...
	 * @return href
	 **/
	@Schema(defaultValue  = "hyperlink reference of the associated product offering price")
	 ...
	 * @return name
	 **/
	@Schema(defaultValue  = "Name of the associated product offering price")
