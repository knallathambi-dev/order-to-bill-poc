...
public class AttachmentRefOrValue {
	 ...
	 * @return id
	 **/
	@Schema(defaultValue  = "Unique identifier for this particular attachment")
	public String getId() {
		return id;
	}
	 ...
	 * @return href
	 **/
	@Schema(defaultValue  = "URI for this Attachment")
	 ...
	 **/
	@Schema(defaultValue  = "Attachment type such as video, picture")
	 ...
	 * @return content
	 **/
	@Schema(defaultValue  = "The actual contents of the attachment object, if embedded, encoded as base64")
	 ...
	 * @return mimeType
	 **/
	@Schema(defaultValue  = "Attachment mime type such as extension file for video, picture and document")
	 ...
	 * @return name
	 **/
	@Schema(defaultValue  = "The name of the attachment")
	 ...
	 * @return url
	 **/
	@Schema(defaultValue  = "Uniform Resource Locator, is a web page address (a subset of URI)")
