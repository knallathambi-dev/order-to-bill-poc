...
public class ServiceCandidateRef {
	 ...
	 * @return id
	 **/
	@Schema(required = true, defaultValue  = "Unique identifier of the service candidate")
	public String getId() {
		return id;
	}
	 ...
	 * @return href
	 **/
	@Schema(defaultValue  = "Unique reference of the service candidate")
	 ...
	 * @return name
	 **/
	@Schema(defaultValue  = "Name of the service candidate")
	 ...
	 * @return version
	 **/
	@Schema(defaultValue  = "Version of the service candidate")
