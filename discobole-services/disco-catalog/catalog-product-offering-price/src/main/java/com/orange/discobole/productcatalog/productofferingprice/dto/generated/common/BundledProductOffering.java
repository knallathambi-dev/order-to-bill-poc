...
public class BundledProductOffering {
	 ...
	 * @return id
	 **/
	@Schema(defaultValue  = "Unique identifier of the BundledProductOffering")
	public String getId() {
		return id;
	}
	 ...
	 * @return href
	 **/
	@Schema(defaultValue  = "Unique reference of the BundledProductOffering")
	 ...
	 **/
	@Schema(defaultValue  = "Used to indicate the current lifecycle status")
	 ...
	 * @return name
	 **/
	@Schema(defaultValue  = "Name of the BundledProductOffering")
