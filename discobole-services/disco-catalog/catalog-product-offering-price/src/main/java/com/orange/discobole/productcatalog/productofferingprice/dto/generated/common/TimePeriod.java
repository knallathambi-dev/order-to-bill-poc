...
public class TimePeriod {
	 ...
	 * @return endDateTime
	 **/
	@Schema(defaultValue  = "End of the time period, using IETC-RFC-3339 format")
	 ...
	 **/
	@Schema(defaultValue  = "Start of the time period, using IETC-RFC-3339 format. If you define a start, you must also define an end")
