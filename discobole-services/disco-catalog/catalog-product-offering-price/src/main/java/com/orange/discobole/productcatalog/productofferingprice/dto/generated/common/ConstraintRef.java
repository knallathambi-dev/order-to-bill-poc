...
public class ConstraintRef {
	 ...
	 * @return id
	 **/
	@Schema(required = true, defaultValue = "reference id to the target constraint")
	public String getId() {
		return id;
	}
	 ...
	 * @return href
	 **/
	@Schema(defaultValue  = "Hyperlink reference to the target constraint")
	 ...
	 * @return name
	 **/
	@Schema(defaultValue  = "Name given to the constraint")
	 ...
	 * @return version
	 **/
	@Schema(defaultValue  = "constraint version")
	 ...
	 * @return referredType
	 **/
	@Schema(defaultValue  = "The (class) type of the referred constraint")
