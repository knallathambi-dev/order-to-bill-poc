...
public class BundledProductOfferingOption {
	 ...
	 **/
	@Schema(defaultValue  = "Default number of produc offereings that should be procured as part of the related BundledProductOffering")
	 ...
	 **/
	@Schema(defaultValue  = "lower limit for a product offering that can be procured as part of the related BundledProductOffering")
	 ...
	 **/
	@Schema(defaultValue  = "upper limit for a product offering that can be procured as part of the related BundledProductOffering")
	...
	@Override
	public int hashCode() {
		return Objects.hash(numberRelOfferDefault, numberRelOfferLowerLimit, numberRelOfferUpperLimit, baseType,
				schemaLocation, type);
	}
