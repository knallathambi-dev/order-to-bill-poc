...
public class BundledProductOfferingPriceRelationship {
	 ...
	 * @return id
	 **/
	@Schema(defaultValue  = "Unique identifier of the bundled product offering price")
	public String getId() {
		return id;
	}
	 ...
	 * @return href
	 **/
	@Schema(defaultValue  = "hyperlink reference of the bundled product offering price")
	 ...
	 * @return name
	 **/
	@Schema(defaultValue  = "Name of the bundled product offering price")
