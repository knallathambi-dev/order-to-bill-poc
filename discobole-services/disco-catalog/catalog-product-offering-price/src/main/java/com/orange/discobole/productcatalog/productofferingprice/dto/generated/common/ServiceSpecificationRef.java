...
public class ServiceSpecificationRef {
	 ...
	 * @return id
	 **/
	@Schema(required = true, defaultValue  = "Unique identifier of the service specification")
	public String getId() {
		return id;
	}
	 ...
	 * @return href
	 **/
	@Schema(defaultValue  = "Reference of the serviceSpecification")
	 ...
	 * @return name
	 **/
	@Schema(defaultValue  = "Name of the requiredServiceSpecification")
	 ...
	 * @return version
	 **/
	@Schema(defaultValue  = "Service specification version")
