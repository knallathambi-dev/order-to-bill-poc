 ...
 * @since 1.0
 */
@Component("isPriceTypeInstallment")
public class ProductOfferingPriceTypeGuardInstallmentPlan implements StateMachineGuard<String,String> {
	...
	public Mono<Boolean> apply(StateContext<String, String> context) {
		return Mono.just(context.getExtendedState().getVariables().get(ProductOfferingPriceConstants.SELECT_POP_TYPE)
				.equals(ProductOfferingPriceType.INSTALLMENTCHARGE.toString()));
	}
}
