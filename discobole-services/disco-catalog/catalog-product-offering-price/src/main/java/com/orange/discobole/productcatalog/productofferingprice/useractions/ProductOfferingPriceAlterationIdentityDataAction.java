 ...
 * @since 1.0
 */
@Component("ProductOfferingPriceCreation.defineProductOfferingPriceAlterationIdentityData")
public class ProductOfferingPriceAlterationIdentityDataAction implements UserAction {
