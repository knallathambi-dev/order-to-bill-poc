...
public class TargetServiceSchema {
	 ...
	 **/
	@Schema(required = true, defaultValue = "This field provides a link to the schema describing the target service")
	 ...
	 * @return type
	 **/
	@Schema(required = true, defaultValue = "Class type of the target service")
