...
class MongodbDataCleanServiceTest extends ProductOfferingPriceApplicationTests {
	...
	void setUp() {
		...
		ReflectionTestUtils.setField(mongodbDataCleanService, "productOfferingPriceService",
	...
	void testScheduleProductOfferingPrice() {
		...
		mongodbDataCleanService.productOfferingPriceDataClean();
		verify(productOfferingPriceService).deleteProductOfferingPrice(any(Long.class), any(OffsetDateTime.class),
				any(String.class));
	}
}
