...
import com.orange.discobole.productcatalog.productofferingprice.useractions.SelectProductOfferingPriceTypeAction;

class SelectProductOfferingPriceTypeActionTest extends ProductOfferingPriceApplicationTests {

	@InjectMocks
	private SelectProductOfferingPriceTypeAction productOfferingPriceTypeAction;
	...
	void performTest() {
		...
		Assertions.assertEquals(3, perform.size());
