...
class ProductOfferingPriceTypeGuardTest {

	@InjectMocks
	private ProductOfferingPriceTypeGuard productOfferingPriceTypeGuard;

	@Test
	void testEvaluate() {
		productOfferingPriceTypeGuard = new ProductOfferingPriceTypeGuard();
		...
		Assertions.assertTrue(productOfferingPriceTypeGuard.apply(context).block());
	}
}
