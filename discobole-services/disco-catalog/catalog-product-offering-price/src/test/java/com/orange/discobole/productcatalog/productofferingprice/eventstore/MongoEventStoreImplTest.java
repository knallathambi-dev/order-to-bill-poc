...
class MongoEventStoreImplTest extends ProductOfferingPriceApplicationTests {
	...
	void deleteTest() {
		try {
			mongoEventStoreImpl.deleteEventsByAggreGateId("1");
			Assertions.fail("Events are immutable.");
		} catch (Exception e) {
			//comment
		}
