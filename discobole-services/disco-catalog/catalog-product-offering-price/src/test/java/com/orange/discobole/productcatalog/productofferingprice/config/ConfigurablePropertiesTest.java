...
class ConfigurablePropertiesTest extends ProductOfferingPriceApplicationTests {
	...
	@BeforeEach
	void setup() {
		configurableProperties.setProductOfferingPriceUrl("1");
	}

	@Test
	void testConfigurableProperties() {
		Assertions.assertEquals("1", configurableProperties.getProductOfferingPriceUrl());
	}
}
