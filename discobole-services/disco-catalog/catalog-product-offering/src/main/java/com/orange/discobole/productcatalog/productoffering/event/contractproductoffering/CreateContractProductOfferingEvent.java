 ...
 * @since 1.0
 */
public final class CreateContractProductOfferingEvent implements ContractProductOfferingEvent {
	 ...
	 * @param type
	 */
	public CreateContractProductOfferingEvent(String productOfferingId, OffsetDateTime lastUpdate, Boolean isSellable,
	...
	public CreateContractProductOfferingEvent() {
	...
	public String toString() {
		return "CreateContractProductOfferingEvent [productOfferingId=" + productOfferingId + ", lastUpdate=" + lastUpdate
