...
package com.orange.discobole.productcatalog.productoffering.interceptor;
...
//		CompletableFuture.runAsync(() -> {
			...
			logBuilder.append(sanitizeForLog(request.getMethod().toString()))
					.append(": ").append(sanitizeForLog(request.getURI().toString()))
					.append(System.lineSeparator())
					.append("Payload: ============================>")
					.append(System.lineSeparator())
					.append(sanitizeForLog(new String(body, StandardCharsets.UTF_8)));
