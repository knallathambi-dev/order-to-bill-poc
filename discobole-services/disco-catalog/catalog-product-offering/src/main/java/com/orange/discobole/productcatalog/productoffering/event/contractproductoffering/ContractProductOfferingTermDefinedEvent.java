...
/**
 * The Class ContractProductOfferingTermDefinedEvent defines contract product
 * offering term using valid for entered and verified.
 *
 * @author Vishal Vachaspati
 * @since 1.0
 */
public class ContractProductOfferingTermDefinedEvent implements ContractProductOfferingEvent {
	 ...
	 * @param lastUpdate
	 */
	public ContractProductOfferingTermDefinedEvent(String productOfferingId,
	...
	public ContractProductOfferingTermDefinedEvent() {
		super();
	...
	public String toString() {
		return "ContractProductOfferingTermDefinedEvent [productOfferingId=" + productOfferingId
