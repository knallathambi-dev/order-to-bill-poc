...
/**
 * The {@code com.orange.bos.productoffering.config.ConfigurableProperties}
...
public class ConfigurableProperties {
	...
	private String productCatalogAdministrationUrl;
	...
	public String getProductCatalogAdministrationUrl() {
		return productCatalogAdministrationUrl;
	}

	public void setProductCatalogAdministrationUrl(String productCatalogAdministrationUrl) {
		this.productCatalogAdministrationUrl = productCatalogAdministrationUrl;
	}
}
