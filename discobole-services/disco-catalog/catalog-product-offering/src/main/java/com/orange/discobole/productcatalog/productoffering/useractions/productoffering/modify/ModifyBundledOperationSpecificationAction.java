 ...
 * @since 1.0
 */
@Component("ProductOfferingModification.modifybundleddefOperation")
public class ModifyBundledOperationSpecificationAction implements UserAction {

	private static final Logger LOGGER = LogManager.getLogger(ModifyBundledOperationSpecificationAction.class);
	...
	public Map<String, Object> perform(StateMachineTransition stateMachineTransition, TaskFlowUpdate taskFlowUpdate)
		...
		productOfferingService.modifyBundledProductOfferingOperation(productOffId, operationSpecifications);
		return new HashMap<>();
