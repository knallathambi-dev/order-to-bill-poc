...
@Component("ProductOfferingModification.modifyPolicyRuleData")
public class ModifyPolicyRuleAction implements UserAction {
    ...
    public Map<String, Object> perform(StateMachineTransition stateMachineTransition, TaskFlowUpdate taskFlowUpdate) throws ParameterException {
        ...
        productOfferingService.modifyProductOfferingPolicyRuleAssociation(productOffId, policyRules);
        return new HashMap<>();
    }
