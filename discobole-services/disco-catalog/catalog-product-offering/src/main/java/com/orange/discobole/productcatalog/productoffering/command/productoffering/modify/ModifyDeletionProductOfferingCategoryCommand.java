...
public class ModifyDeletionProductOfferingCategoryCommand {
	...
	public ModifyDeletionProductOfferingCategoryCommand(String productOfferingId, Set<CategoryRef> categories, String productOfferingType) {
	...
	public String toString() {
		return "ModifyDeletionProductOfferingCategoryCommand{" +
