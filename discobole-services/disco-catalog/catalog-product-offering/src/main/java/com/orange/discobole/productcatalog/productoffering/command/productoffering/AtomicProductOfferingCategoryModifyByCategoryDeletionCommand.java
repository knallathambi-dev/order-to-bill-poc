...
public class AtomicProductOfferingCategoryModifyByCategoryDeletionCommand {
	...
	public AtomicProductOfferingCategoryModifyByCategoryDeletionCommand(String productOfferingId, Set<CategoryRef> addCategories,
	...
	public AtomicProductOfferingCategoryModifyByCategoryDeletionCommand() {
		super();
	...
	public String toString() {
		return "AtomicProductOfferingCategoryModifyByCategoryDeletionCommand [productOfferingId=" + productOfferingId + ", addCategories="
