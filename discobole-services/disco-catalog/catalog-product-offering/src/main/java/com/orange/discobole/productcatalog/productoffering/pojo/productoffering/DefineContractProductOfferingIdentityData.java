...
/**
 * The Class DefineContractProductOfferingIdentityData describes the Contract
 * product offering identity data.
 *
 * @author Vishal Vachaspati
 * @since 1.0
 */
public class DefineContractProductOfferingIdentityData {
