...
public class BundleProductOfferingIndirectCategoryModifiedEvent implements ProductOfferingEvent {
    ...
    public BundleProductOfferingIndirectCategoryModifiedEvent(String productOfferingId, Set<CategoryRef> addCategories,
    ...
    public BundleProductOfferingIndirectCategoryModifiedEvent() {
        super();
    ...
    public String toString() {
        return "BundleProductOfferingIndirectCategoryIModifiedEvent [productOfferingId=" + productOfferingId + ", addCategories="
