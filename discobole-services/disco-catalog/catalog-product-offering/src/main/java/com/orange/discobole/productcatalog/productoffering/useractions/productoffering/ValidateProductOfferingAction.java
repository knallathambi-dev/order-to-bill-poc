...
/**
 * The Class ValidateProductOfferingAction validates product offering when user
 * clicks on validate.
 *
 * @author Diksha Srivastava
 * @since 1.0
 */
@Component("ProductOfferingCreation.validate")
public class ValidateProductOfferingAction implements UserAction {
