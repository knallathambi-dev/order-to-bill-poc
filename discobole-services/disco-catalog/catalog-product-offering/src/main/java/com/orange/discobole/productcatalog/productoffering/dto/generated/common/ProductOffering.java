...
public class ProductOffering {
	 ...
	 * Get allowedAction
	 *
	 * Mandatory for Contract Product Offering.
	 * Each allowedAction must have at least one action and channels must be subset of ProductOffering channels.
	 *
	 * @return allowedAction
	 **/
	...
	public int hashCode() {
		return Objects.hash(id, href, description, isBundle, isSellable, isVisible, isInstallable, lastUpdate, lifecycleStatus,
				...
				commercialOperation, policyRuleRef,
				productOfferingRelationship, numberBundledOfferLowerLimit, globalMinCardinality,
				globalMaxCardinality, numberBundledOfferUpperLimit, baseType, schemaLocation, type);
	}
