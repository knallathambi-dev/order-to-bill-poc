 ...
 * @since 1.0
 */
public final class AtomicProductOfferingIdentityDataDefinedEvent implements ProductOfferingEvent {
	...
	public AtomicProductOfferingIdentityDataDefinedEvent(String productOfferingId, DefineIdentityData identityData,
	...
	public AtomicProductOfferingIdentityDataDefinedEvent() {
	...
	public String toString() {
		return "AtomicProductOfferingIdentityDataDefinedEvent [productOfferingId=" + productOfferingId
