...
/**
 * Event raised to modify the PO Description from the user.
 *
 * @author Vishal Vachaspati
 * @since 1.0
 */
public class AtomicProductOfferingDescribedModifiedEvent implements ProductOfferingEvent {
	...
	public AtomicProductOfferingDescribedModifiedEvent(){
	 ...
	 * @param lastUpdate
	 */
	public AtomicProductOfferingDescribedModifiedEvent(String productOfferingId, String description, String statusReason,
	...
	public String toString() {
		return "ProductOfferingDescribedModifiedEvent [productOfferingId=" + productOfferingId + ", description="
