...
public class ManageProductOfferingBundlingCommand {
	 ...
	 */
	public ManageProductOfferingBundlingCommand(String productOfferingId,List<BundledProductOffering> bundleProductOfferings,
