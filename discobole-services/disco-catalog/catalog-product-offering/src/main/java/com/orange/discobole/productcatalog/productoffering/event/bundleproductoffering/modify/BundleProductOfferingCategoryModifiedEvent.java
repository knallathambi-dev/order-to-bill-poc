 ...
 * @since 1.0
 */
public class BundleProductOfferingCategoryModifiedEvent implements ProductOfferingEvent {
	...
	public BundleProductOfferingCategoryModifiedEvent(String productOfferingId, Set<CategoryRef> addCategories,
	...
	public BundleProductOfferingCategoryModifiedEvent() {
		super();
	...
	public String toString() {
		return "BundleProductOfferingCategoryIModifiedEvent [productOfferingId=" + productOfferingId + ", addCategories="
