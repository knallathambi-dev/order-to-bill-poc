...
/**
 * ProductOfferingCheckPoTypeGaurd defines Condition to be executed when state
 * reaches Operation state.
 *
 * @author Vishal Vachaspati
 * @since 1.0
 */
@Component("checkPoType")
public class ProductOfferingCheckPoTypeGaurd implements StateMachineGuard<String, String>{
