 ...
 * @since 1.0
 */
public final class ProductOfferingIdentityDataCommand {
	...
	public ProductOfferingIdentityDataCommand(String productOfferingId, DefineIdentityData identityData, Set<String> channelIds,
	...
	public String toString() {
		return "ProductOfferingIdentityDataCommand{" +
