 ...
 * @since 1.0
 */
public class ContractProductOfferingDescriptionCommand {
	...
	public ContractProductOfferingDescriptionCommand(String productOfferingId, DefineContractIdentityData identityData,
	...
	public String toString() {
		return "ContractProductOfferingDescriptionCommand [productOfferingId=" + productOfferingId + ", identityData="
				...
				+ type + ", statusReason=" + statusReason + ", lastUpdate=" + lastUpdate + "]";
	}
