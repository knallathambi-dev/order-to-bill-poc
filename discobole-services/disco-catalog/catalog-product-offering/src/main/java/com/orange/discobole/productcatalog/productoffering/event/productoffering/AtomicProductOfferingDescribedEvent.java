 ...
 * @since 1.0
 */
public final class AtomicProductOfferingDescribedEvent implements ProductOfferingEvent {
	...
	private AtomicProductOfferingDescribedEvent() {
	...
	public AtomicProductOfferingDescribedEvent(String productOfferingId, String description, String statusReason,
	...
	public String toString() {
		return "AtomicProductOfferingDescribedEvent{" +
