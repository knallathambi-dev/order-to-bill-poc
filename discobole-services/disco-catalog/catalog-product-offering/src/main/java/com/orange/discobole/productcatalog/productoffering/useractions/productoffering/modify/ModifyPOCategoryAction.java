...
/**
 * The Class ModifyPOCategoryAction provides the user input to modify categories
 * for product offering.
 *
 * @author Vishal Vachaspati
 * @since 1.0
 */
@Component("ProductOfferingModification.modifyPOCategoryData")
public class ModifyPOCategoryAction implements UserAction {
	...
	public Map<String, Object> perform(StateMachineTransition stateMachineTransition, TaskFlowUpdate taskFlowUpdate) {
		...
		productOfferingService.modifyProductOfferingCategory(productOffId, categoryIds);
		return new HashMap<>();
	}
