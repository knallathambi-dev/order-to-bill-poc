...
/**
 * The Class ModifyPORelationshipAction provides the user input to modify
 * relationship for product offering.
 *
 * @author Vishal Vachaspati
 * @since 1.0
 */
@Component("ProductOfferingModification.modifyPORelationshipData")
public class ModifyPORelationshipAction implements UserAction {
	...
	public Map<String, Object> perform(StateMachineTransition stateMachineTransition, TaskFlowUpdate taskFlowUpdate) {
		...
		productOfferingService.modifyProductOfferingRelationship(productOffId, relationships);
		return new HashMap<>();
	}
