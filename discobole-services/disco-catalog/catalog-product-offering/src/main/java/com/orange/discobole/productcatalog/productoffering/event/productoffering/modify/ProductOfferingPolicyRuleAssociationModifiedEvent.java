...
public class ProductOfferingPolicyRuleAssociationModifiedEvent implements ProductOfferingEvent {
    ...
    private ProductOfferingPolicyRuleAssociationModifiedEvent() {
        this.productOfferingId = null;
        this.productOfferingPolicyRuleAssociation = null;
        this.lastUpdate = null;
    }

    public ProductOfferingPolicyRuleAssociationModifiedEvent(String productOfferingId, List<PolicyRuleRef> productOfferingPolicyRuleAssociation, OffsetDateTime lastUpdate) {
    ...
    public String toString() {
        return "ProductOfferingPolicyRuleAssociationModifiedEvent{" +
                "productOfferingId='" + productOfferingId + '\'' +
                ", productOfferingPolicyRuleAssociation=" + productOfferingPolicyRuleAssociation +
