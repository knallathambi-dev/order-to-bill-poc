...
public class AssociatePOPtoOperationSpecification {
	...
	private List<AssociatePOPtoTerm> productOfferingTerm;
	...
	public List<AssociatePOPtoTerm> getProductOfferingTerm() {
		return productOfferingTerm;
	}

	public void setProductOfferingTerm(List<AssociatePOPtoTerm> productOfferingTerm) {
