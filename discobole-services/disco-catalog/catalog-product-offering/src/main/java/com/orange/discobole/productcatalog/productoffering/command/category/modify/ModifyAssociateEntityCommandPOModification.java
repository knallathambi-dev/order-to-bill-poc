...
package com.orange.discobole.productcatalog.productoffering.command.category.modify;
...
public class ModifyAssociateEntityCommandPOModification {
	@TargetAggregateIdentifier
	private final String categoryId;

	private final Set<ProductOfferingRef> productOfferingIds;

	public ModifyAssociateEntityCommandPOModification(String categoryId, Set<ProductOfferingRef> productOfferingIds) {
		super();
