 ...
 * @since 1.0
 */
@Component("checkNotAtomicPo")
public class NotAtomicProductOfferingCheckGaurd implements StateMachineGuard<String, String>{
	...
	public Mono<Boolean> apply(StateContext<String, String> context) {
		return Mono.just(((String)context.getExtendedState().getVariables().get(ProductOffConstants.PRODUCTOFFERINGTYPE))
				.equalsIgnoreCase(ProductOfferingType.CONTRACT.toString()) ||
