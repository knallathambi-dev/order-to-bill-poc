...
import com.orange.discobole.productcatalog.productoffering.useractions.productoffering.ProductOffDescAction;

class ProductOffDescActionTest extends ProductOfferingApplicationTests {

	@InjectMocks
	private ProductOffDescAction productOffDescAction;
	...
	void performProductOfferingDescriptionWhenUserEntersValues() {
		...
		verify(productOfferingService).defineProductOffDesc(PRODUCTOFFID, defineIdentityData,new HashSet<String>() ,
				new HashSet<String>(),new HashSet<RelatedParty>(),new HashSet<ProductOfferingTerm>(),null,
				 null, "Product Offering initial creation");
	}
