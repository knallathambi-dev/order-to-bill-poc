...
import com.orange.discobole.productcatalog.productoffering.useractions.productoffering.modify.ModifyPOAssociatePOPtoOperationSpecificationAction;

class ModifyPOAssociatePOPtoOperationSpecActionTest extends ProductOfferingApplicationTests {
	@InjectMocks
	private ModifyPOAssociatePOPtoOperationSpecificationAction associatePOPtoOperationSpecificationAction;
	...
	void perform() {
		...
		Map<String, Object> performVariables = associatePOPtoOperationSpecificationAction
				.perform(stateMachineTransition, taskFlowUpdate);
