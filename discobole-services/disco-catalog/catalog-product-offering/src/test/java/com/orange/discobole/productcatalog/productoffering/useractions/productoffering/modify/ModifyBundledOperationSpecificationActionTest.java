...
import com.orange.discobole.productcatalog.productoffering.useractions.productoffering.modify.ModifyBundledOperationSpecificationAction;
...
class ModifyBundledOperationSpecificationActionTest extends ProductOfferingApplicationTests{
	
	@InjectMocks
    private ModifyBundledOperationSpecificationAction modifyBundledOperationSpecificationAction;
    ...
    @BeforeEach
    void init() {
        ReflectionTestUtils.setField(modifyBundledOperationSpecificationAction, "objectMapper", objectMapper);
        productOffering.setId(PRODUCTOFFID);
        productOffering.setLifecycleStatus(ProductOfferingLifecycle.ACTIVE);
        modifyBundledOperationSpecificationAction.init();
    }
    ...
    void performTest() throws JsonProcessingException {
        ...
        Map<String, Object> performVariables = modifyBundledOperationSpecificationAction.perform(stateMachineTransition, taskFlowUpdate);
    ...
    void performCharateristicGetTest() {
        ...
        List<CharacteristicSpecification> charact = modifyBundledOperationSpecificationAction.requiredCharacteristics(stateMachineTransition, null);
