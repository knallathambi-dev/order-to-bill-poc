...
class BundleProductOfferingSelectedEventTest extends ProductOfferingApplicationTests {
	...
	void bundleProductOfferingSelectedEventTest() {
		Assertions.assertAll("bundleProductOfferingSelectedEvent",
				...
				() -> Assertions.assertEquals(bundleProductOfferingSelectedEvent.getBundleProductOffering(),
						characteristicList));
		LOGGER.info("bundleProductOfferingSelectedEvent: {}", bundleProductOfferingSelectedEvent);
	}
