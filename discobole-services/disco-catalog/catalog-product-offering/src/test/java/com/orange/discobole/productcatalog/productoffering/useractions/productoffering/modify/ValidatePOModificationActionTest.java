...
import com.orange.discobole.productcatalog.productoffering.useractions.productoffering.modify.ValidatePOModificationAction;

class ValidatePOModificationActionTest extends ProductOfferingApplicationTests {

	@InjectMocks
	private ValidatePOModificationAction userAction;
	...
	void performProductOfferingValidationWhenUserClicksOnValidate() {
		...
		verify(productOfferingService).validateProductOfferingModification(PRODUCTOFFID,null);
	}
