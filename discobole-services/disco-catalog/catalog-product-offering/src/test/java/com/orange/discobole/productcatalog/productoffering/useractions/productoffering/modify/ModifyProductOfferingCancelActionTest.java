...
import com.orange.discobole.productcatalog.productoffering.useractions.productoffering.modify.ModifyProductOfferingCancelAction;

class ModifyProductOfferingCancelActionTest extends ProductOfferingApplicationTests {

	@InjectMocks
	private ModifyProductOfferingCancelAction productOffCancelAction;
	...
	void performTest() {
		...
		Mockito.verify(productOffService, Mockito.times(1)).cancelProductOfferingModification(PRODUCTOFFID);
