...
import com.orange.discobole.productcatalog.productoffering.useractions.productoffering.DefineProductOfferingCharacteristicsAction;

class DefineProductOfferingCharacteristicsActionTest extends ProductOfferingApplicationTests {

    @InjectMocks
    private DefineProductOfferingCharacteristicsAction defineProductOfferingCharacteristicsAction;
    ...
    @BeforeEach
    void init() {
        ReflectionTestUtils.setField(defineProductOfferingCharacteristicsAction, "objectMapper", objectMapper);
        defineProductOfferingCharacteristicsAction.init();
    }
    ...
    void performProductOfferingCharacteristicsWhenUserEntersValues() {
        ...
        Map<String, Object> performVariables = defineProductOfferingCharacteristicsAction.perform(stateMachineTransition, taskFlowUpdate);
        assertThat(performVariables).isNotEmpty();
    }
