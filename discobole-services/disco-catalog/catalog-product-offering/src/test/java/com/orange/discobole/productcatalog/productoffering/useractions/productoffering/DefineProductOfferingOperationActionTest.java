...
import com.orange.discobole.productcatalog.productoffering.useractions.productoffering.DefineOperationSpecificationAction;

class DefineProductOfferingOperationActionTest extends ProductOfferingApplicationTests {

    @InjectMocks
    private DefineOperationSpecificationAction defineOperationSpecificationAction;
