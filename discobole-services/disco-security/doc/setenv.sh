...
function setup_mkdocs() {
  ...
  if [ -n "$TEST" ]; then  
    ...
    [
      {   
        "path": "disco/disco-oda-components/disco-security",
        "visibility": "internal",
        "exclude": ["security-authorization-architecture", "doc", "security-authorization-tests", "gitlab-profile"],
        "type": "oda-component",
        "name": "User Role and Permission Management",
        "doc": "https://discobole.ow2.io/disco-oda-components/disco-security/doc/"
      } 
    ]'
  fi
  ...
  [
      {   
        "path": "disco/disco-oda-components/disco-security",
        "visibility": "internal",
        "exclude": ["security-authorization-component", "security-authorization-architecture", "doc", "security-authorization-tests", "gitlab-profile"],
        "type": "oda-component",
        "name": "User Role and Permission Management",
        "doc": "https://discobole.ow2.io/disco-oda-components/disco-security/doc/"
      }  
