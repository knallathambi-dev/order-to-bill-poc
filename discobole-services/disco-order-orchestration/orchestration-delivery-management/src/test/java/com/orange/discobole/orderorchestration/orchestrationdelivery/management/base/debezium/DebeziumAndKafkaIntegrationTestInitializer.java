...
package com.orange.discobole.orderorchestration.orchestrationdelivery.management.base.debezium;
...
public class DebeziumAndKafkaIntegrationTestInitializer implements ApplicationContextInitializer<ConfigurableApplicationContext> {
    ...
    @Container
    public static final DebeziumContainer debeziumContainer = new DebeziumContainer("dockerproxy.repos.tech.orange/debezium/connect:2.6.1.Final")
            .withNetwork(network)
