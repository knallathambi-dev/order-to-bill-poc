...
public class RelatedProductOrderItemNotFoundException extends CoodNotFoundException {
    public RelatedProductOrderItemNotFoundException(ExceptionCode exceptionCode, Object... parameters) {
        super(exceptionCode, parameters);
    }

    @Override
    public String getMessage() {
        return "RELATED_PRODUCT_ORDER_ITEM_NOT_FOUND_EXCEPTION".concat(CODE_REASON_MESSAGE_FORMATING)
