...
public class NodeDeliveryHandlerNotFoundException extends CoodNotFoundException {
    public NodeDeliveryHandlerNotFoundException(ExceptionCode exceptionCode, Object... parameters) {
        super(exceptionCode, parameters);
    }

    @Override
    public String getMessage() {
        return "NODE_DELIVERY_HANDLER_NOT_FOUND_EXCEPTION".concat(CODE_REASON_MESSAGE_FORMATING)
