...
public class ProductCharacteristicsNotFoundException extends CoodNotFoundException {
    public ProductCharacteristicsNotFoundException(ExceptionCode exceptionCode, Object... parameters) {
        super(exceptionCode, parameters);
    }

    @Override
    public String getMessage() {
        return "PRODUCT_CHARACTERISTICS_NOT_FOUND_EXCEPTION".concat(CODE_REASON_MESSAGE_FORMATING)
