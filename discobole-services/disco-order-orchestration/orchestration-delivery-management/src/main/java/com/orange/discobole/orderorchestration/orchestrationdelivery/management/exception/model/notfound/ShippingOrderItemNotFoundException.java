...
public class ShippingOrderItemNotFoundException extends CoodNotFoundException {
    public ShippingOrderItemNotFoundException(ExceptionCode exceptionCode, Object... parameters) {
        super(exceptionCode, parameters);
    }

    @Override
    public String getMessage() {
        return "SHIPPING_ORDER_ITEM_NOT_FOUND_EXCEPTION".concat(CODE_REASON_MESSAGE_FORMATING)
