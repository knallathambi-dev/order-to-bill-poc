...
public class DeliveryHandlerEventNotFoundException extends CoodNotFoundException {
    public DeliveryHandlerEventNotFoundException(ExceptionCode exceptionCode, Object... parameters) {
        super(exceptionCode, parameters);
    }

    @Override
    public String getMessage() {
        return "DELIVERY_HANDLER_EVENT_NOT_FOUND_EXCEPTION".concat(CODE_REASON_MESSAGE_FORMATING)
