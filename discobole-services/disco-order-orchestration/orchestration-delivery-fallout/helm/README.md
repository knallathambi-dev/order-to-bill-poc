...
A Helm chart for orchestration delivery fallout service.

**Homepage:** <https://discobole.ow2.io/doc>

## Source Code

* <https://gitlab.ow2.org/discobole/disco-order-orchestration/orchestration-delivery-fallout>
...
| som_mock_job_cron_expression | string | `""` | Schedule cron to mock SOM factory |
