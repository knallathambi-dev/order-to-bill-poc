...
public class CreateJsonFromPOJO {
    ...
    public static void main(String[] args) throws IOException {
        ...
        Reflections reflections = new Reflections("com.orange.disco.orchestration.fallout.pojo.spec.characteristic.operation",
        ...
        for (Class<?> type : allClasses) {
            ...
            try {
                ...
                if ("com.orange.disco.orchestration.fallout.pojo.spec.characteristic.operation".equals(packageName)) {
