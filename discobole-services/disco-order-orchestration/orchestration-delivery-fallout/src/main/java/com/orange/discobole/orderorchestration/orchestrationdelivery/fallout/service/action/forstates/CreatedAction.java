...
@Component("CreatedAction")
@RequiredArgsConstructor
public class CreatedAction implements StateMachineStateAction<String, String> {
    ...
    public Mono<Void> apply(StateContext<String, String> context) {
        if (!context.getTransition().getSource().getId().equals(State.CREATED.getValue())) {
            return Mono.empty();
        }
