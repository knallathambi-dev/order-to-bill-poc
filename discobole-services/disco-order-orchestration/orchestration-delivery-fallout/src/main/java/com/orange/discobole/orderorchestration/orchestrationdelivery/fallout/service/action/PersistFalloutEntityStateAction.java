...
package com.orange.discobole.orderorchestration.orchestrationdelivery.fallout.service.action;
...
@Component("PersistFalloutEntityStateAction")
@RequiredArgsConstructor
public class PersistFalloutEntityStateAction implements StateMachineStateAction<String, String> {
