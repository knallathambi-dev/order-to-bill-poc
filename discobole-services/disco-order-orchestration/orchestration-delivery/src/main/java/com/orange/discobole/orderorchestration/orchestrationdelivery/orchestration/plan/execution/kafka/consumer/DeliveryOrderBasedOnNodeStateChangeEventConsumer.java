...
public class DeliveryOrderBasedOnNodeStateChangeEventConsumer {
    ...
    @KafkaListener(
            ...
            groupId = "${app.kafka.batch-process-group-id}"
    )
    ...
    public void deadLetterTopic(Message<OrchestrationPlanNodeStateChangeEvent> message, @Header(KafkaHeaders.RECEIVED_TOPIC) String topicName,
        ...
        log.info("DeliveryOrderBasedOnNodeStateChangeEventConsumer | deadLetterTopic | Dead letter topic {} received: {} , with offset {} ", topicName, message, offset);
