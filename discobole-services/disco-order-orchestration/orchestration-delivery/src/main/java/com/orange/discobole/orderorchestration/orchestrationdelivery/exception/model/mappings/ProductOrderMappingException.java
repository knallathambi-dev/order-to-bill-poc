...
public class ProductOrderMappingException extends CoodMappingException {
    public ProductOrderMappingException(ExceptionCode exceptionCode, Class<?> entityName, Class<?> targetEntityName, Object... parameters) {
        super(exceptionCode, entityName, targetEntityName, parameters);
    }

    @Override
    public String getMessage() {
        return "PRODUCT_ORDER_MAPPING_EXCEPTION | code: {%s} | message: {%s} | reason: {%s} | entityName: {%s} | targetEntityName: {%s}"
