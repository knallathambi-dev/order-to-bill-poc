...
public class FalloutHttpFailedException extends CoodHttpFailedException {

    public FalloutHttpFailedException() {
        super();
    }

    public FalloutHttpFailedException(String message, String uriString, HttpStatusCode statusCode, ExceptionCode exceptionCode, WebClientResponseException webClientResponseException) {
    ...
    public String getLogMessage() {
        return "%s | COOD_FO_HTTP_FAILED_EXCEPTION | URL: {%s} | HTTP_STATUS: {%s} | message: %s".formatted(getExceptionCode(),
