...
public class PCHttpFailedException extends CoodHttpFailedException {

    public PCHttpFailedException() {
    }

    public PCHttpFailedException(String message, String url, HttpStatusCode statusCode) {
        super(message, url, statusCode);
    }

    public PCHttpFailedException(String message, String uriString, HttpStatusCode statusCode, WebClientResponseException webClientResponseException) {
    ...
    public PCHttpFailedException(String message, String uriString, HttpStatusCode statusCode, ExceptionCode exceptionCode, WebClientResponseException webClientResponseException) {
    ...
    public String getLogMessage() {
        return "%s | COOD_PC_HTTP_FAILED_EXCEPTION | URL: {%s} | HTTP_STATUS: {%s} | message: %s".formatted(getExceptionCode(),
