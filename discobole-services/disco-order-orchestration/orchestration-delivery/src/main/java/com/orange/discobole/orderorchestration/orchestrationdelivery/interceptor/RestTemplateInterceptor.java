...
package com.orange.discobole.orderorchestration.orchestrationdelivery.interceptor;
...
public class RestTemplateInterceptor implements ClientHttpRequestInterceptor {
    ...
    @NotNull
    @Override
    public ClientHttpResponse intercept(@NotNull final HttpRequest request, @NotNull final byte[] body,
