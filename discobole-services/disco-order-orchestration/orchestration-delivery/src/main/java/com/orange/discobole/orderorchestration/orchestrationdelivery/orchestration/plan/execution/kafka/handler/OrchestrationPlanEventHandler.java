...
public interface OrchestrationPlanEventHandler {
    void handleEvent(OrchestrationPlanStateChangeEvent message);

    void handleDeadLetter(OrchestrationPlanStateChangeEvent payload, FalloutCharacteristicWrapper characteristicWrapper);
}
