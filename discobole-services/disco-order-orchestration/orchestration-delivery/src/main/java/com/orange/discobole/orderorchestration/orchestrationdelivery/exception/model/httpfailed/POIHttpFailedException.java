...
public class POIHttpFailedException extends CoodHttpFailedException {


    public POIHttpFailedException() {
    }

    public POIHttpFailedException(String message, String uriString, HttpStatusCode statusCode, ExceptionCode exceptionCode, WebClientResponseException webClientResponseException) {
    ...
    public String getLogMessage() {
        return "%s | COOD_POI_HTTP_FAILED_EXCEPTION | URL: {%s} | HTTP_STATUS: {%s} | message: %s".formatted(getExceptionCode(),
