...
@SelectClasspathResource("features/context/mocked/eventPublisher")
@ConfigurationParameter(
        key = GLUE_PROPERTY_NAME,
        value = "com.orange.discobole.orderorchestration.orchestrationdelivery.cucumber.tests.context.mocked.eventPublisher," +
