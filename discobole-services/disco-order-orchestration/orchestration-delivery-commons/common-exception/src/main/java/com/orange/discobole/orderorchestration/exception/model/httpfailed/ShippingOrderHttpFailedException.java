...
public class ShippingOrderHttpFailedException extends CoodHttpFailedException {

    public ShippingOrderHttpFailedException() {
        super();
    }

    public ShippingOrderHttpFailedException(String message, String uriString, HttpStatusCode statusCode, ExceptionCode exceptionCode, WebClientResponseException webClientResponseException) {
