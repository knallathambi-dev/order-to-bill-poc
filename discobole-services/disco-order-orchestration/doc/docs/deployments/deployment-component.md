---
title: Deploying DISCOBOLE Order Orchestration Component
summary:
authors:
  - DISCOBOLE Team
---

# Deploy your own DISCOBOLE Order Orchestration Instance
...
To deploy the component manually, you will have to deploy each service of the component:
...
??? note "Build Java Services on your Workstation"
    ...
    - `orchestration-delivery`[readme.md](../../architecture/detailed-architecture/orchestration-delivery/)
    - `orchestration-delivery-fallout`[readme.md](../../architecture/detailed-architecture/orchestration-delivery-fallout/)
    - `orchestration-delivery-management`[readme.md](../../architecture/detailed-architecture/orchestration-delivery-management/)
