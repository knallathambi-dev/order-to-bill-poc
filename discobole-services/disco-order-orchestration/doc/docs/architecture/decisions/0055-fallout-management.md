...
In the context of our system architecture COOD, we are initiating the fallout process within the COOD and DM (../
...
We will use a process flow within a new service inside the COOD component (../
