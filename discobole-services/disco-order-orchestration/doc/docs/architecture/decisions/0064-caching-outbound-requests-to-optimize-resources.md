...
|                        | In App Memory Caching         | Centralized Caching (../
|------------------------|------------------------------|------------------------------------|
...
- Caching architecture:
  - When Redis is enabled, use layered caching: in-memory (../1) with Redis as L2 to reduce network hops to the Redis cluster.
- On read cache TTLs:
...
Use Spring Cache annotations and introduce both in-memory (../
