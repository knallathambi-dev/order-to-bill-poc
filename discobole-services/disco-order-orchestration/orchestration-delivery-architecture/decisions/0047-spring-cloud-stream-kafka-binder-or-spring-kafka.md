...
- [Stack Overflow - Spring Kafka vs. Spring Cloud Stream Kafka](https://stackoverflow.com/questions/47312542/spring-kafka-vs-spring-cloud-stream-kafka)
- [Confluent Blog - Spring for Apache Kafka Deep Dive](https://www.confluent.io/en-gb/blog/spring-for-apache-kafka-deep-dive-part-2-apache-kafka-spring-cloud-stream/)
