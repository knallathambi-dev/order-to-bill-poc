...
Log all ADRs (Architecture Decision Records) related to `Customer Order Orchestration and Delivery`.

To add new ADRs, please follow this [ADR template](decisions/adr-template.md).
