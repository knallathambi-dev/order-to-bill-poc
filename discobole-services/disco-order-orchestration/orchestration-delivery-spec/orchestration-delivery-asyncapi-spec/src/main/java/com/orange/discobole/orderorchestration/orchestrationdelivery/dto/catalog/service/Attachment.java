...
public class Attachment {
    ...
    private List<Attachment> relatedParty;
    /**
    ...
    private List<Attachment> serviceSpecRelationship;
    /**
    ...
    private List<Attachment> specCharacteristic;
    /**
     * ServiceSpecification is a class that offers characteristics to describe a type of service.
     * Functionally, it acts as a template by which Services may be instantiated. By sharing the same specification, these services would therefore share the same set of characteristics.
     * 
     ...
     */
    @JsonProperty("relatedParty")
    public List<Attachment> getRelatedParty() {
        return relatedParty;
    }
     ...
     */
    @JsonProperty("relatedParty")
    public void setRelatedParty(List<Attachment> relatedParty) {
     ...
     */
    @JsonProperty("serviceSpecRelationship")
    public List<Attachment> getServiceSpecRelationship() {
     ...
     */
    @JsonProperty("serviceSpecRelationship")
    public void setServiceSpecRelationship(List<Attachment> serviceSpecRelationship) {
     ...
     */
    @JsonProperty("specCharacteristic")
    public List<Attachment> getSpecCharacteristic() {
     ...
     */
    @JsonProperty("specCharacteristic")
    public void setSpecCharacteristic(List<Attachment> specCharacteristic) {
     ...
     */
    @JsonProperty("validFor")
    public void setValidFor(Attachment validFor) {
