...
???+ abstract "Live Environment Overview"
    ...
    Once GitLab CI/CD hand over to OpenShift, OpenShift can instantiate CPIB microservice and its database. All theses components are monitored and tracked by tools such as _Jaeger_, _Grafana_, _Fluentd_, _Loki_ and _Prometheus_.
...
???+ info "GitLab CI Pipelines"
    - [Order Capture pipelines](https://gitlab.ow2.org/discobole/disco-oda-components/disco-order-management/order-capture/-/pipelines)
    - [Order Followup pipelines](https:///gitlab.ow2.org/discobole/disco-oda-components/disco-order-management/order-followup/-/pipelines)
    - [Product Order Inventory pipelines](https://gitlab.ow2.org/discobole/disco-oda-components/disco-order-management/order-inventory/-/pipelines)