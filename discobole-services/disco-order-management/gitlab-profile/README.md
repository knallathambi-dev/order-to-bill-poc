...
# Order Management (OM) Component

Responsible of the OTB processes Order Capture and Order Follow-Up, and include a Product Order Inventory (POI) repository which stores all customer product orders.
...
Then clone all repositories of `disco-order-management`, as follows:

```bash
git-all clone discobole/disco-oda-components/disco-order-management
```
