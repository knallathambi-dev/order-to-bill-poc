...
public interface ServiceQualificationManagementService {
    CheckServiceQualification checkServiceQualification(CheckServiceQualification checkServiceQualification);
}