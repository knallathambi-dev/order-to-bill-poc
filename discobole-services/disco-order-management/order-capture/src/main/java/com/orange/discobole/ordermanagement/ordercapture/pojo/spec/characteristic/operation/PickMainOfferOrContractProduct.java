...
@Getter
@Setter
public class PickMainOfferOrContractProduct {
    @JsonProperty("id")
    @NotBlank
    @NotNull
    @ReadOnly(true)
    ...
    @NotNull
    @ReadOnly(true)
    private ReferredType referredType;

    @JsonProperty("optionalProductOfferingId")
    @ReadOnly(true)
    private String optionalProductOfferingId;
}