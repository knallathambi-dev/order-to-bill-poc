...
${name}     FTTH Premium
*** Test Cases ***
Aquisition ftth Premium default
    ...
    [Tags]                      Test_Suite_Package_Ftth_Premium
                            ...
                            ${Product_Offering_Id}      the customer get product id from catalog for ${name}
                             ...
                             Update "add" Characteristique Fiber acces "Basic"
...
Aquisition ftth Premium Fiber Basic MSLicence Basic
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_Ftth_Premium
                            ...
                            ${Product_Offering_Id}      the customer get product id from catalog for ${name}
                             ...
                             and Update Product Configuration "Instore"
                             Update "add" Characteristique Fiber acces "Basic"
                             Update "add" Characteristique MSLicence "Basic"
    ${response}             Given the user executes the POST api "${Api_POST_PF}" with the endpoint "${EndPoint_Om_Oc}" to create a process flow
                            And the "${response}" status code should be "201"
                            # Step 2 : Select Offer [Valid]
    ${request_body}         When the user uses the PATCH request body of "selectOfferOrContract"
...
Aquisition ftth Premium Fiber Basic MSLicence Standard
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_Ftth_Premium
                            ...
                            ${Product_Offering_Id}      the customer get product id from catalog for ${name}
                             ...
                             and Update Product Configuration "Instore"
                             Update "add" Characteristique Fiber acces "Basic"
                             Update "add" Characteristique MSLicence "Standard"
    ${response}             Given the user executes the POST api "${Api_POST_PF}" with the endpoint "${EndPoint_Om_Oc}" to create a process flow
                            And the "${response}" status code should be "201"
                            # Step 2 : Select Offer [Valid]
    ${request_body}         When the user uses the PATCH request body of "selectOfferOrContract"
...
Aquisition ftth Premium Fiber Basic MSLicence Premium
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_Ftth_Premium
                            ...
                            ${Product_Offering_Id}      the customer get product id from catalog for ${name}
                             ...
                             and Update Product Configuration "Instore"
                             Update "add" Characteristique Fiber acces "Basic"
                             Update "add" Characteristique MSLicence "Premium"
    ${response}             Given the user executes the POST api "${Api_POST_PF}" with the endpoint "${EndPoint_Om_Oc}" to create a process flow
                            And the "${response}" status code should be "201"
                            # Step 2 : Select Offer [Valid]
    ${request_body}         When the user uses the PATCH request body of "selectOfferOrContract"
...
Aquisition ftth Premium Fiber Expert MSLicence Basic
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_Ftth_Premium
                            ...
                            ${Product_Offering_Id}      the customer get product id from catalog for ${name}
                             ...
                             and extract id from Configurator "${response}"
                             and Update Product Configuration "Instore"
                             Update "add" Characteristique Fiber acces "Expert"
                             Update "add" Characteristique MSLicence "Basic"
    ${response}             Given the user executes the POST api "${Api_POST_PF}" with the endpoint "${EndPoint_Om_Oc}" to create a process flow
                            And the "${response}" status code should be "201"
                            # Step 2 : Select Offer [Valid]
...
Aquisition ftth Premium Fiber Expert MSLicence Standard
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_Ftth_Premium
...
Aquisition ftth Premium Fiber Expert MSLicence Premium
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_Ftth_Premium
