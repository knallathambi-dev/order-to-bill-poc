...
*** Test Cases ***
Aquisition smart contract with internet and modify device insurance Premium
    ...
    [Tags]                      Test_Suite_Package_Smart_Contract_Aquisition_modification
    ...
    ${response}             Then the user executes the PATCH api with the "pay_order" href "['_links']['nextTaskstoBePerformed'][1]['href']" of the "${response}" using specific "${request_body}"
                            ...
                            and extract all ids from CPIB of "${relatedEntity_id}"
                            and Modification Device Insurance Premium       ${relatedEntity_id}
    [Teardown]             Teardown Test Case


Aquisition smart contract with internet and modify device insurance Basic
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_Smart_Contract_Aquisition_modification
    ...
    ${response}             Then the user executes the PATCH api with the "pay_order" href "['_links']['nextTaskstoBePerformed'][1]['href']" of the "${response}" using specific "${request_body}"
                            ...
                            And the nextTaskstoBePerformed List of "${response}" is empty
                            and extract all ids from CPIB of "${relatedEntity_id}"
                            and Modification Device Insurance basic       ${relatedEntity_id}
    [Teardown]             Teardown Test Case


Aquisition smart contract with internet and modify netflix Standard
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_Smart_Contract_Aquisition_modification
    ...
    ${response}             Then the user executes the PATCH api with the "pay_order" href "['_links']['nextTaskstoBePerformed'][1]['href']" of the "${response}" using specific "${request_body}"
                            ...
                            And the nextTaskstoBePerformed List of "${response}" is empty
                            and extract all ids from CPIB of "${relatedEntity_id}"
                            and Modification Netflix Standard       ${relatedEntity_id}
    [Teardown]             Teardown Test Case


Aquisition smart contract with internet and modify Netflix Basic
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_Smart_Contract_Aquisition_modification
    ...
    ${response}             Then the user executes the PATCH api with the "pay_order" href "['_links']['nextTaskstoBePerformed'][1]['href']" of the "${response}" using specific "${request_body}"
                            ...
                            And the nextTaskstoBePerformed List of "${response}" is empty
                            and extract all ids from CPIB of "${relatedEntity_id}"
                            and Modification Netflix basic       ${relatedEntity_id}
    [Teardown]             Teardown Test Case

Aquisition smart contract with internet and modify netflix,device Insurance to Standard
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_Smart_Contract_Aquisition_modification
    ...
    ${response}             Then the user executes the PATCH api with the "pay_order" href "['_links']['nextTaskstoBePerformed'][1]['href']" of the "${response}" using specific "${request_body}"
                            ...
                            And the nextTaskstoBePerformed List of "${response}" is empty
                            and extract all ids from CPIB of "${relatedEntity_id}"
                            and Modification Netflix and device insurance Premium       ${relatedEntity_id}
    [Teardown]             Teardown Test Case


Aquisition smart contract with internet and modify netflix,device Insurance Basic
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_Smart_Contract_Aquisition_modification
    ...
    ${response}             Then the user executes the PATCH api with the "pay_order" href "['_links']['nextTaskstoBePerformed'][1]['href']" of the "${response}" using specific "${request_body}"
                            ...
                            And the nextTaskstoBePerformed List of "${response}" is empty
                            and extract all ids from CPIB of "${relatedEntity_id}"
                            and Modification Netflix and device insurance basic       ${relatedEntity_id}
    [Teardown]             Teardown Test Case

Aquisition smart contract with internet and modify HBO Max
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_Smart_Contract_Aquisition_modification
    ...
    ${response}             Then the user executes the PATCH api with the "pay_order" href "['_links']['nextTaskstoBePerformed'][1]['href']" of the "${response}" using specific "${request_body}"
                            ...
                            And the nextTaskstoBePerformed List of "${response}" is empty
                            and extract all ids from CPIB of "${relatedEntity_id}"
                            and Modification Add-on HBO Max       ${relatedEntity_id}
    [Teardown]             Teardown Test Case


Aquisition smart contract with internet and modify HBO
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_Smart_Contract_Aquisition_modification
    ...
    ${response}             Then the user executes the PATCH api with the "pay_order" href "['_links']['nextTaskstoBePerformed'][1]['href']" of the "${response}" using specific "${request_body}"
                            ...
                            And the nextTaskstoBePerformed List of "${response}" is empty
                            and extract all ids from CPIB of "${relatedEntity_id}"
                            and Modification Add-on HBO       ${relatedEntity_id}
    [Teardown]             Teardown Test Case
