...
${name}     Mobile Package Max Plus
*** Test Cases ***


Valid Prepaid Mobile Offer MaxPlus Aquisition Instore + modification add Ring
    ...
    [Tags]                      Test_Suite_Package_MaxPlus_Aquisition_And_Modification
...
Valid Prepaid Mobile Offer MaxPlus Aquisition Instore + modification add SMS
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_MaxPlus_Aquisition_And_Modification
                            Given This token must be created
                            ${Product_Offering_Id_MAX}      the customer get product id from catalog for ${name}
...
Valid Prepaid Mobile Offer MaxPlus Aquisition Instore + modification add SMS Ring
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_MaxPlus_Aquisition_And_Modification
                            Given This token must be created
                            ${Product_Offering_Id_MAX}      the customer get product id from catalog for ${name}
...
Valid Prepaid Mobile Offer MaxPlus Aquisition Instore + modification modify ring VIP
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_MaxPlus_Aquisition_And_Modification
                            Given This token must be created
                            ${Product_Offering_Id_MAX}      the customer get product id from catalog for ${name}
...
Valid Prepaid Mobile Offer MaxPlus Aquisition Instore + modification modify ring Basic
        [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
        [Tags]                      Test_Suite_Package_MaxPlus_Aquisition_And_Modification
                                Given This token must be created
                                ${Product_Offering_Id_MAX}      the customer get product id from catalog for ${name}
...
Valid Prepaid Mobile Offer MaxPlus Aquisition Instore + modification Add SMS modify ring VIP
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_MaxPlus_Aquisition_And_Modification
                            Given This token must be created
                            ${Product_Offering_Id_MAX}      the customer get product id from catalog for ${name}
...
Valid Prepaid Mobile Offer MaxPlus Aquisition Instore + modification Add SMS modify ring Basic
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_MaxPlus_Aquisition_And_Modification
                            Given This token must be created
                            ${Product_Offering_Id_MAX}      the customer get product id from catalog for ${name}
...
Valid Prepaid Mobile Offer MaxPlus Aquisition Instore + modification Delete ring
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_MaxPlus_Aquisition_And_Modification
                            Given This token must be created
                            ${Product_Offering_Id_MAX}      the customer get product id from catalog for ${name}
...
Valid Prepaid Mobile Offer MaxPlus Aquisition Instore + modification add SMS Delete ring
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_MaxPlus_Aquisition_And_Modification
                            Given This token must be created
                            ${Product_Offering_Id_MAX}      the customer get product id from catalog for ${name}
...
Valid Prepaid Mobile Offer MaxPLUS Aquisition Instore + modification add Handset
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_MaxPlus_Aquisition_And_Modification
                            Given This token must be created
                            ${Product_Offering_Id_MAX}      the customer get product id from catalog for ${name}
          ...
          #                  And the user checks that the status of productOrder "${relatedEntity_id}" is "accepted"
           #                 And the user checks that the status PI of productOrder "${relatedEntity_id}" is "Confirmed"
                         # Assuming you have extracted all the required IDs into variables
                           and extract all ids from CPIB of "${relatedEntity_id_Max}"
                           Wait Until Keyword Succeeds    7 min    10s    Check Status Completed of "${relatedEntity_id_Max}"
                           and Modification Add handset Mobile Offer MaxPlus          ${relatedEntity_id_Max}

    [Teardown]             Teardown Test Case


Valid Prepaid Mobile Offer MaxPLUS Aquisition Instore + modification add Handset Add SMS
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_MaxPlus_Aquisition_And_Modification
                            Given This token must be created
                            ${Product_Offering_Id_MAX}      the customer get product id from catalog for ${name}
          ...
          #                  And the user checks that the status of productOrder "${relatedEntity_id}" is "accepted"
           #                 And the user checks that the status PI of productOrder "${relatedEntity_id}" is "Confirmed"
                         # Assuming you have extracted all the required IDs into variables
                           and extract all ids from CPIB of "${relatedEntity_id_Max}"
                           Wait Until Keyword Succeeds    7 min    10s    Check Status Completed of "${relatedEntity_id_Max}"
                           and Modification Add handset and SMS Mobile Offer MaxPlus          ${relatedEntity_id_Max}

    [Teardown]             Teardown Test Case

Valid Prepaid Mobile Offer MaxPLUS Aquisition Instore + modification add Handset Add Ring VIP
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_MaxPlus_Aquisition_And_Modification
                            Given This token must be created
                            ${Product_Offering_Id_MAX}      the customer get product id from catalog for ${name}
          ...
          #                  And the user checks that the status of productOrder "${relatedEntity_id}" is "accepted"
           #                 And the user checks that the status PI of productOrder "${relatedEntity_id}" is "Confirmed"
                         # Assuming you have extracted all the required IDs into variables
                           and extract all ids from CPIB of "${relatedEntity_id_Max}"
                           Wait Until Keyword Succeeds    7 min    10s    Check Status Completed of "${relatedEntity_id_Max}"
                           and Modification Add handset and Ring VIP tone Mobile Offer MaxPlus          ${relatedEntity_id_Max}

    [Teardown]             Teardown Test Case

Valid Prepaid Mobile Offer MaxPLUS Aquisition Instore + modification add Handset Add Ring Free
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_MaxPlus_Aquisition_And_Modification
                            Given This token must be created
                            ${Product_Offering_Id_MAX}      the customer get product id from catalog for ${name}
          ...
          #                  And the user checks that the status of productOrder "${relatedEntity_id}" is "accepted"
           #                 And the user checks that the status PI of productOrder "${relatedEntity_id}" is "Confirmed"
                         # Assuming you have extracted all the required IDs into variables
                           and extract all ids from CPIB of "${relatedEntity_id_Max}"
                           Wait Until Keyword Succeeds    7 min    10s    Check Status Completed of "${relatedEntity_id_Max}"
                           and Modification Add handset and Ring Free tone Mobile Offer MaxPlus          ${relatedEntity_id_Max}

    [Teardown]             Teardown Test Case

Valid Prepaid Mobile Offer MaxPLUS Aquisition Instore + modification add Handset Add Ring Basic
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_MaxPlus_Aquisition_And_Modification
                            Given This token must be created
                            ${Product_Offering_Id_MAX}      the customer get product id from catalog for ${name}
          ...
          #                  And the user checks that the status of productOrder "${relatedEntity_id}" is "accepted"
           #                 And the user checks that the status PI of productOrder "${relatedEntity_id}" is "Confirmed"
                         # Assuming you have extracted all the required IDs into variables
                           and extract all ids from CPIB of "${relatedEntity_id_Max}"
                           Wait Until Keyword Succeeds    7 min    10s    Check Status Completed of "${relatedEntity_id_Max}"
                           and Modification Add handset and Ring Basic tone Mobile Offer MaxPlus          ${relatedEntity_id_Max}

    [Teardown]             Teardown Test Case

Valid Prepaid Mobile Offer MaxPLUS Aquisition Instore + modification add Handset Add SMS Add Ring VIP
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_MaxPlus_Aquisition_And_Modification
                            Given This token must be created
                            ${Product_Offering_Id_MAX}      the customer get product id from catalog for ${name}
          ...
          #                  And the user checks that the status of productOrder "${relatedEntity_id}" is "accepted"
           #                 And the user checks that the status PI of productOrder "${relatedEntity_id}" is "Confirmed"
                         # Assuming you have extracted all the required IDs into variables
                           and extract all ids from CPIB of "${relatedEntity_id_Max}"
                           Wait Until Keyword Succeeds    7 min    10s    Check Status Completed of "${relatedEntity_id_Max}"
                           and Modification Add handset, SMS and Ring VIP tone Mobile Offer MaxPlus          ${relatedEntity_id_Max}

    [Teardown]             Teardown Test Case


Valid Prepaid Mobile Offer MaxPLUS Aquisition Instore + modification add Handset Add SMS Add Ring Free
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_MaxPlus_Aquisition_And_Modification
                            Given This token must be created
                            ${Product_Offering_Id_MAX}      the customer get product id from catalog for ${name}
          ...
          #                  And the user checks that the status of productOrder "${relatedEntity_id}" is "accepted"
           #                 And the user checks that the status PI of productOrder "${relatedEntity_id}" is "Confirmed"
                         # Assuming you have extracted all the required IDs into variables
                           and extract all ids from CPIB of "${relatedEntity_id_Max}"
                           Wait Until Keyword Succeeds    7 min    10s    Check Status Completed of "${relatedEntity_id_Max}"
                           and Modification Add handset, SMS and Ring Free tone Mobile Offer MaxPlus          ${relatedEntity_id_Max}
...
Valid Prepaid Mobile Offer MaxPLUS Aquisition Instore + modification add Handset Mod Ring VIP
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_MaxPlus_Aquisition_And_Modification
                            Given This token must be created
                            ${Product_Offering_Id_MAX}      the customer get product id from catalog for ${name}
          ...
          #                  And the user checks that the status of productOrder "${relatedEntity_id}" is "accepted"
           #                 And the user checks that the status PI of productOrder "${relatedEntity_id}" is "Confirmed"
                         # Assuming you have extracted all the required IDs into variables
                           and extract all ids from CPIB of "${relatedEntity_id_Max}"
                           Wait Until Keyword Succeeds    7 min    10s    Check Status Completed of "${relatedEntity_id_Max}"
                           and Modification Add Handset Mod Ring Mobile Offer MaxPlus VIP Tone          ${relatedEntity_id_Max}

    [Teardown]             Teardown Test Case



Valid Prepaid Mobile Offer MaxPLUS Aquisition Instore + modification add Handset Mod Ring Basic
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_MaxPlus_Aquisition_And_Modification
                            Given This token must be created
                            ${Product_Offering_Id_MAX}      the customer get product id from catalog for ${name}
          ...
          #                  And the user checks that the status of productOrder "${relatedEntity_id}" is "accepted"
           #                 And the user checks that the status PI of productOrder "${relatedEntity_id}" is "Confirmed"
                         # Assuming you have extracted all the required IDs into variables
                           and extract all ids from CPIB of "${relatedEntity_id_Max}"
                           Wait Until Keyword Succeeds    7 min    10s    Check Status Completed of "${relatedEntity_id_Max}"
                           and Modification Add Handset Mod Ring Mobile Offer MaxPlus Basic Tone          ${relatedEntity_id_Max}

    [Teardown]             Teardown Test Case
Valid Prepaid Mobile Offer MaxPLUS Aquisition Instore + modification add Handset Del Ring
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_MaxPlus_Aquisition_And_Modification
                            Given This token must be created
                            ${Product_Offering_Id_MAX}      the customer get product id from catalog for ${name}
          ...
          #                  And the user checks that the status of productOrder "${relatedEntity_id}" is "accepted"
           #                 And the user checks that the status PI of productOrder "${relatedEntity_id}" is "Confirmed"
                         # Assuming you have extracted all the required IDs into variables
                           and extract all ids from CPIB of "${relatedEntity_id_Max}"
                           Wait Until Keyword Succeeds    7 min    10s    Check Status Completed of "${relatedEntity_id_Max}"
                           and Modification Add Handset Del Ring Mobile Offer MaxPlus          ${relatedEntity_id_Max}

    [Teardown]             Teardown Test Case

Valid Prepaid Mobile Offer MaxPLUS Aquisition Instore + modification add Handset add SMS Mod Ring Basic
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_MaxPlus_Aquisition_And_Modification
                            Given This token must be created
                            ${Product_Offering_Id_MAX}      the customer get product id from catalog for ${name}
          ...
          #                  And the user checks that the status of productOrder "${relatedEntity_id}" is "accepted"
           #                 And the user checks that the status PI of productOrder "${relatedEntity_id}" is "Confirmed"
                         # Assuming you have extracted all the required IDs into variables
                           and extract all ids from CPIB of "${relatedEntity_id_Max}"
                           Wait Until Keyword Succeeds    7 min    10s    Check Status Completed of "${relatedEntity_id_Max}"
                           and Modification Add Handset Add SMS Mod Ring Mobile Offer MaxPlus Basic Tone          ${relatedEntity_id_Max}

    [Teardown]             Teardown Test Case

Valid Prepaid Mobile Offer MaxPLUS Aquisition Instore + modification add Handset add SMS Mod Ring Vip
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_MaxPlus_Aquisition_And_Modification
                            Given This token must be created
                            ${Product_Offering_Id_MAX}      the customer get product id from catalog for ${name}
          ...
          #                  And the user checks that the status of productOrder "${relatedEntity_id}" is "accepted"
           #                 And the user checks that the status PI of productOrder "${relatedEntity_id}" is "Confirmed"
                         # Assuming you have extracted all the required IDs into variables
                           and extract all ids from CPIB of "${relatedEntity_id_Max}"
                           Wait Until Keyword Succeeds    7 min    10s    Check Status Completed of "${relatedEntity_id_Max}"
                           and Modification Add Handset Add SMS Mod Ring Mobile Offer MaxPlus VIP Tone          ${relatedEntity_id_Max}

    [Teardown]             Teardown Test Case

Valid Prepaid Mobile Offer MaxPLUS Aquisition Instore + modification add Handset add SMS Del Ring Vip
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_MaxPlus_Aquisition_And_Modification
                            Given This token must be created
                            ${Product_Offering_Id_MAX}      the customer get product id from catalog for ${name}
          ...
          #                  And the user checks that the status of productOrder "${relatedEntity_id}" is "accepted"
           #                 And the user checks that the status PI of productOrder "${relatedEntity_id}" is "Confirmed"
                         # Assuming you have extracted all the required IDs into variables
                           and extract all ids from CPIB of "${relatedEntity_id_Max}"
                           Wait Until Keyword Succeeds    7 min    10s    Check Status Completed of "${relatedEntity_id_Max}"
                           and Modification Add Handset Add SMS Del Ring Mobile Offer MaxPlus Basic Tone          ${relatedEntity_id_Max}
...
Valid Prepaid Mobile Offer MaxPlus Aquisition ome delivery + modification add Ring
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_MaxPlus_Aquisition_And_Modification
...
Valid Prepaid Mobile Offer MaxPlus Aquisition home delivery + modification add SMS
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_MaxPlus_Aquisition_And_Modification
                            Given This token must be created
                            ${Product_Offering_Id_MAX}      the customer get product id from catalog for ${name}
...
Valid Prepaid Mobile Offer MaxPlus Aquisition home delivery + modification add SMS Ring
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_MaxPlus_Aquisition_And_Modification
                            Given This token must be created
                            ${Product_Offering_Id_MAX}      the customer get product id from catalog for ${name}
...
Valid Prepaid Mobile Offer MaxPlus Aquisition home delivery + modification modify ring VIP
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_MaxPlus_Aquisition_And_Modification
                            Given This token must be created
                            ${Product_Offering_Id_MAX}      the customer get product id from catalog for ${name}
...
Valid Prepaid Mobile Offer MaxPlus Aquisition home delivery + modification modify ring Basic
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_MaxPlus_Aquisition_And_Modification
                            Given This token must be created
                            ${Product_Offering_Id_MAX}      the customer get product id from catalog for ${name}
...
Valid Prepaid Mobile Offer MaxPlus Aquisition home delivery + modification Add SMS modify ring VIP
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_MaxPlus_Aquisition_And_Modification
                            Given This token must be created
                            ${Product_Offering_Id_MAX}      the customer get product id from catalog for ${name}
...
Valid Prepaid Mobile Offer MaxPlus Aquisition home delivery + modification Add SMS modify ring Basic
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_MaxPlus_Aquisition_And_Modification
                            Given This token must be created
                            ${Product_Offering_Id_MAX}      the customer get product id from catalog for ${name}
...
Valid Prepaid Mobile Offer MaxPlus Aquisition home delivery + modification Delete ring
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_MaxPlus_Aquisition_And_Modification
                            Given This token must be created
                            ${Product_Offering_Id_MAX}      the customer get product id from catalog for ${name}
...
Valid Prepaid Mobile Offer MaxPlus Aquisition home delivery + modification add SMS Delete ring
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                     Test_Suite_Package_MaxPlus_Aquisition_And_Modification
                            Given This token must be created
                            ${Product_Offering_Id_MAX}      the customer get product id from catalog for ${name}
