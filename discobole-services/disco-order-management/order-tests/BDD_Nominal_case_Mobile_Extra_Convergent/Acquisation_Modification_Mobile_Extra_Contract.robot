...
${Product_Offering_Id}  c20e80e4-73cc-4a64-8c75-3d451f50f54e
*** Test Cases ***
Aquisition Mobile Extra modify data extra bundle 100
    ...
    [Tags]                      Test_Suite_Package_extra_Contract_Aquisition_modification
...
Aquisition Mobile Extra modify data extra bundle 50
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_extra_Contract_Aquisition_modification
...
Aquisition Mobile Extra modify data extra bundle 50 and netflix basic
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_extra_Contract_Aquisition_modification
...
Aquisition Mobile Extra modify data extra bundle 50 and netflix Standard
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_extra_Contract_Aquisition_modification
...
Aquisition Mobile Extra modify data extra bundle 100 and netflix basic
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_extra_Contract_Aquisition_modification
...
Aquisition Mobile Extra modify data extra bundle 100 and netflix Standard
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_extra_Contract_Aquisition_modification
