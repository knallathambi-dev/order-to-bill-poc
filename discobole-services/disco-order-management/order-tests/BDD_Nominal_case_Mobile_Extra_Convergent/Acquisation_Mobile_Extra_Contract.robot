...
${name}    Mobile Extra Contract
*** Test Cases ***

Aquisition Mobile Extra Bundle commitment 12 extra bundle 50 netflix Basic Instore
    ...
    [Tags]                      Test_Suite_Package_Mobile_Extra_Convergent_Aquisition
...
Aquisition Mobile Extra Bundle commitment 12 extra bundle 50 Standard Basic Instore
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_Mobile_Extra_Convergent_Aquisition
...
Aquisition Mobile Extra Bundle commitment 12 extra bundle 100 netflix Basic Instore
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_Mobile_Extra_Convergent_Aquisition
...
Aquisition Mobile Extra Bundle commitment 12 extra bundle 100 Standard Basic Instore
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_Mobile_Extra_Convergent_Aquisition
...
Aquisition Mobile Extra Bundle commitment 24 extra bundle 50 netflix Basic Instore
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_Mobile_Extra_Convergent_Aquisition
...
Aquisition Mobile Extra Bundle commitment 24 extra bundle 50 Standard Basic Instore
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_Mobile_Extra_Convergent_Aquisition
...
Aquisition Mobile Extra Bundle commitment 24 extra bundle 100 netflix Basic Instore
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_Mobile_Extra_Convergent_Aquisition
...
Aquisition Mobile Extra Bundle commitment 24 extra bundle 100 Standard Basic Instore
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_Mobile_Extra_Convergent_Aquisition
