...
the customer create for modificaion a product Configuration for ${GLOBAL_CONTRACT_IDS}
     ...
     ${MY_FILE}=     OperatingSystem.Get File       Global_Configuration/DATA/DATA_Product_Configurator/POST Product Configurator Modification.json
     ${body}=        evaluate    json.loads('''${MY_FILE}''')      json
         Log    ${body}
