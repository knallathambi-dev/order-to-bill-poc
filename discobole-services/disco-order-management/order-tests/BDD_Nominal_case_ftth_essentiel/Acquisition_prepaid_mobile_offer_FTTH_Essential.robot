...
${name}     FTTH Essential
*** Test Cases ***
Aquisition ftth Essential default
    ...
    [Tags]                      Test_Suite_Package_Ftth_Essential
                            ...
                            ${Product_Offering_Id}      the customer get product id from catalog for ${name}
                             ...
                             and Update "add" Characteristique Fiber acces "Basic"
...
Aquisition ftth Essential fiber Basic Internet Boost
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_Ftth_Essential
...
Aquisition ftth Essential fiber Basic Static Ipv4
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_Ftth_Essential
                            ...
                            ${Product_Offering_Id}      the customer get product id from catalog for ${name}
                             ...
                             and Update Product Configuration "Instore"
                             and Update "add" Characteristique Fiber acces "Basic"
                             and Update Static IPV4 Address
    ${response}             Given the user executes the POST api "${Api_POST_PF}" with the endpoint "${EndPoint_Om_Oc}" to create a process flow
                            And the "${response}" status code should be "201"
                            # Step 2 : Select Offer [Valid]
    ${request_body}         When the user uses the PATCH request body of "selectOfferOrContract"
...
Aquisition ftth Essential fiber Basic 4G Backup
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_Ftth_Essential
...
Aquisition ftth Essential fiber Basic InternetBoost , Static Ipv4
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_Ftth_Essential
...
Aquisition ftth Essential fiber Internet Boost , 4G Backup
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_Ftth_Essential
...
Aquisition ftth Essential fiber Basic Static Ipv4 , 4G Backup
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_Ftth_Essential
...
Aquisition ftth Essential fiber Basic internetBoost , Static Ipv4 , 4G Backup
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_Ftth_Essential
...
Aquisition ftth Essential default Fiber Expert
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_Ftth_Essential
                            ...
                            ${Product_Offering_Id}      the customer get product id from catalog for ${name}
                             ...
                             and extract id from Configurator "${response}"
                             and Update Product Configuration "Instore"
                             and Update "add" Characteristique Fiber acces "Expert"
    ${response}             Given the user executes the POST api "${Api_POST_PF}" with the endpoint "${EndPoint_Om_Oc}" to create a process flow
                            And the "${response}" status code should be "201"
                            # Step 2 : Select Offer [Valid]
    ${request_body}         When the user uses the PATCH request body of "selectOfferOrContract"
...
Aquisition ftth Essential fiber Expert Internet Boost
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_Ftth_Essential
...
Aquisition ftth Essential fiber Expert Static Ipv4
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_Ftth_Essential
...
Aquisition ftth Essential fiber Expert 4G Backup
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_Ftth_Essential
...
Aquisition ftth Essential fiber Expert InternetBoost , Static Ipv4
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_Ftth_Essential
...
Aquisition ftth Essential fiber Expert Internet Boost , 4G Backup
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_Ftth_Essential
...
Aquisition ftth Essential fiber Expert Static Ipv4 , 4G Backup
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_Ftth_Essential
...
Aquisition ftth Essential fiber Expert internetBoost , Static Ipv4 , 4G Backup
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_Ftth_Essential
