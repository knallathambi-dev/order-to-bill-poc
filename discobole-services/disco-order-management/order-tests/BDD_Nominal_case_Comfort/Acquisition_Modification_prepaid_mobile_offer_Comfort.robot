...
*** Test Cases ***
Valid Prepaid Mobile Offer Comfort Instore + Modif ADD DATA PASS 1GB
    ...
    [Tags]                      Test_Suite_Package_Comfort_Aquisition_And_Modification
        ...
        ${response}             Then the user executes the PATCH api with the "pay_order" href "['_links']['nextTaskstoBePerformed'][1]['href']" of the "${response}" using specific "${request_body}"
              ...
              #                  And the user checks that the status of productOrder "${relatedEntity_id}" is "accepted"
               #                 And the user checks that the status PI of productOrder "${relatedEntity_id}" is "Confirmed"
                               ...
                               Wait Until Keyword Succeeds    7 min    10s    Check Status Completed of "${relatedEntity_id_Comfort}"
                               and Modification Data Pass for comfort Package 1GB   ${relatedEntity_id_Comfort}
                            Wait Until Keyword Succeeds    7 min    10s    Check Status Completed of "${relatedEntity_id_Comfort}"
            #                and termination mobile Offer         ${relatedEntity_id_Comfort}
    [Teardown]             Teardown Test Case
Valid Prepaid Mobile Offer Comfort Home delivery + Modif ADD DATA PASS 1GB
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_Comfort_Aquisition_And_Modification
        ...
        ${response}             Then the user executes the PATCH api with the "pay_order" href "['_links']['nextTaskstoBePerformed'][1]['href']" of the "${response}" using specific "${request_body}"
              ...
              #                  And the user checks that the status of productOrder "${relatedEntity_id}" is "accepted"
               #                 And the user checks that the status PI of productOrder "${relatedEntity_id}" is "Confirmed"
                            ...
                            and termination mobile Offer         ${relatedEntity_id_Comfort}
    [Teardown]             Teardown Test Case
Valid Prepaid Mobile Offer Comfort Instore + Modif ADD DATA PASS 2GB
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_Comfort_Aquisition_And_Modification
        ...
        ${response}             Then the user executes the PATCH api with the "pay_order" href "['_links']['nextTaskstoBePerformed'][1]['href']" of the "${response}" using specific "${request_body}"
              ...
              #                  And the user checks that the status of productOrder "${relatedEntity_id}" is "accepted"
               #                 And the user checks that the status PI of productOrder "${relatedEntity_id}" is "Confirmed"
                               ...
                               and extract all ids from CPIB of "${relatedEntity_id_Comfort}"
                               Wait Until Keyword Succeeds    7 min    10s    Check Status Completed of "${relatedEntity_id_Comfort}"
                               and Modification Data Pass for comfort Package 2GB   ${relatedEntity_id_Comfort}
                            Wait Until Keyword Succeeds    7 min    10s    Check Status Completed of "${relatedEntity_id_Comfort}"
                #            and termination mobile Offer         ${relatedEntity_id_Comfort}
    [Teardown]             Teardown Test Case
Valid Prepaid Mobile Offer Comfort Home delivery + Modif ADD DATA PASS 2GB
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_Comfort_Aquisition_And_Modification
