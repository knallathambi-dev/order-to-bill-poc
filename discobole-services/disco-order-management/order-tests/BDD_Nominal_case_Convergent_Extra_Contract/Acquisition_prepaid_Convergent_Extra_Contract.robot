...
${name}     Convergent Extra Contract
*** Test Cases ***
Aquisition Extra bundle 100 TV Channels Basic_146
    ...
    [Tags]                      Test_Suite_Package_Convergent_Extra_Aquisition
                            ...
                            ${Product_Offering_Id}      the customer get product id from catalog for ${name}
                             ...
                             and Update "add" Characteristique Extra Bundle "100"
                             and Update "add" Characteristique TV Channels "Basic_146"
...
Aquisition Extra bundle 50 TV Channels Basic_146
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_Convergent_Extra_Aquisition
                            ...
                            ${Product_Offering_Id}      the customer get product id from catalog for ${name}
                             ...
                             and extract id from Configurator "${response}"
                             and Update Product Configuration "Instore"
                             and Update "add" Characteristique Extra Bundle "50"
                             and Update "add" Characteristique TV Channels "Basic_146"
    ${response}             Given the user executes the POST api "${Api_POST_PF}" with the endpoint "${EndPoint_Om_Oc}" to create a process flow
                            And the "${response}" status code should be "201"
                            # Step 2 : Select Offer [Valid]
...
Aquisition Extra bundle 100 TV Channels Extended_167
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_Convergent_Extra_Aquisition
                            ...
                            ${Product_Offering_Id}      the customer get product id from catalog for ${name}
                             ...
                             and Update Product Configuration "Instore"
                             and Update "add" Characteristique Extra Bundle "100"
                             and Update "add" Characteristique TV Channels "Extended_167"
    ${response}             Given the user executes the POST api "${Api_POST_PF}" with the endpoint "${EndPoint_Om_Oc}" to create a process flow
                            And the "${response}" status code should be "201"
                            # Step 2 : Select Offer [Valid]
    ${request_body}         When the user uses the PATCH request body of "selectOfferOrContract"
...
Aquisition Extra bundle 50 TV Channels Extended_167
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_Convergent_Extra_Aquisition
...
Aquisition Extra bundle 100 TV Channels Basic_146 netflix basic
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_Convergent_Extra_Aquisition
...
Aquisition Extra bundle 50 TV Channels Basic_146 netflix basic
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_Convergent_Extra_Aquisition
...
Aquisition Extra bundle 100 TV Channels Extended_167 netflix basic
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_Convergent_Extra_Aquisition
...
Aquisition Extra bundle 50 TV Channels Extended_167 netflix basic
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_Convergent_Extra_Aquisition
...
Aquisition Extra bundle 100 TV Channels Basic_146 netflix Standard
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_Convergent_Extra_Aquisition
...
Aquisition Extra bundle 50 TV Channels Basic_146 netflix Standard
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_Convergent_Extra_Aquisition
...
Aquisition Extra bundle 100 TV Channels Extended_167 netflix Standard
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_Convergent_Extra_Aquisition
...
Aquisition Extra bundle 50 TV Channels Extended_167 netflix Standard
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_Convergent_Extra_Aquisition
...
Aquisition Extra bundle 100 TV Channels Basic_146 netflix basic 2 tv box
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_Convergent_Extra_Aquisition
                            ...
                            ${Product_Offering_Id}      the customer get product id from catalog for ${name}
                             ...
                             and Update "add" Characteristique TV Channels "Basic_146"
                             and Update "add" Characteristique Netflix "Basic"
                             and Update Characteristique TV Box
    ${response}             Given the user executes the POST api "${Api_POST_PF}" with the endpoint "${EndPoint_Om_Oc}" to create a process flow
                            And the "${response}" status code should be "201"
                            # Step 2 : Select Offer [Valid]
    ${request_body}         When the user uses the PATCH request body of "selectOfferOrContract"
...
Aquisition Extra bundle 50 TV Channels Basic_146 netflix basic 2 tv box
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_Convergent_Extra_Aquisition
...
Aquisition Extra bundle 100 TV Channels Extended_167 netflix basic 2 tv box
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_Convergent_Extra_Aquisition
...
Aquisition Extra bundle 50 TV Channels Extended_167 netflix basic 2 tv box
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_Convergent_Extra_Aquisition
...
Aquisition Extra bundle 100 TV Channels Basic_146 netflix Standard 2 tv box
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_Convergent_Extra_Aquisition
...
Aquisition Extra bundle 50 TV Channels Basic_146 netflix Standard 2 tv box
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_Convergent_Extra_Aquisition
...
Aquisition Extra bundle 100 TV Channels Extended_167 netflix Standard 2 tv box
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_Convergent_Extra_Aquisition
...
Aquisition Extra bundle 50 TV Channels Extended_167 netflix Standard 2 tv box
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_Convergent_Extra_Aquisition
