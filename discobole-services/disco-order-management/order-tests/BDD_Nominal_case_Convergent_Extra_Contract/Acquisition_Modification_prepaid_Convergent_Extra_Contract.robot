...
*** Test Cases ***
Aquisition Convergent Extra modify data extra bundle 100
    ...
    [Tags]                      Test_Suite_Package_Convergent_Extra_Aquisition_modification
    ...
    ${response}             Then the user executes the PATCH api with the "pay_order" href "['_links']['nextTaskstoBePerformed'][1]['href']" of the "${response}" using specific "${request_body}"
                            ...
                            and Modification Data extra Bundle 100       ${relatedEntity_id}
    [Teardown]             Teardown Test Case

Aquisition Convergent Extra modify data extra bundle 50
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_Convergent_Extra_Aquisition_modification
    ...
    ${response}             Then the user executes the PATCH api with the "pay_order" href "['_links']['nextTaskstoBePerformed'][1]['href']" of the "${response}" using specific "${request_body}"
                            ...
                            And the nextTaskstoBePerformed List of "${response}" is empty
                            and extract all ids from CPIB of "${relatedEntity_id}"
                            and Modification Data extra Bundle 50       ${relatedEntity_id}
    [Teardown]             Teardown Test Case

Aquisition Convergent Extra modify data extra bundle 50 and netflix basic
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_Convergent_Extra_Aquisition_modification
    ...
    ${response}             Then the user executes the PATCH api with the "pay_order" href "['_links']['nextTaskstoBePerformed'][1]['href']" of the "${response}" using specific "${request_body}"
                            ...
                            And the nextTaskstoBePerformed List of "${response}" is empty
                            and extract all ids from CPIB of "${relatedEntity_id}"
                            and Modification Netflix Basic and data bundle 50       ${relatedEntity_id}
    [Teardown]             Teardown Test Case

Aquisition Convergent Extra modify data extra bundle 50 and netflix Standard
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_Convergent_Extra_Aquisition_modification
    ...
    ${response}             Then the user executes the PATCH api with the "pay_order" href "['_links']['nextTaskstoBePerformed'][1]['href']" of the "${response}" using specific "${request_body}"
                            ...
                            And the nextTaskstoBePerformed List of "${response}" is empty
                            and extract all ids from CPIB of "${relatedEntity_id}"
                            and Modification Netflix Standard and data bundle 50       ${relatedEntity_id}
    [Teardown]             Teardown Test Case

Aquisition Convergent Extra modify data extra bundle 100 and netflix basic
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_Convergent_Extra_Aquisition_modification
    ...
    ${response}             Then the user executes the PATCH api with the "pay_order" href "['_links']['nextTaskstoBePerformed'][1]['href']" of the "${response}" using specific "${request_body}"
                            ...
                            And the nextTaskstoBePerformed List of "${response}" is empty
                            and extract all ids from CPIB of "${relatedEntity_id}"
                            and Modification Netflix Basic and data bundle 100       ${relatedEntity_id}
    [Teardown]             Teardown Test Case

Aquisition Convergent Extra modify data extra bundle 100 and netflix Standard
    [Documentation]         This test case consists of testing the acquisition of a prepaid offer for an identified customer by demonstrating the necessary steps.
    [Tags]                      Test_Suite_Package_Convergent_Extra_Aquisition_modification
    ...
    ${response}             Then the user executes the PATCH api with the "pay_order" href "['_links']['nextTaskstoBePerformed'][1]['href']" of the "${response}" using specific "${request_body}"
                            ...
                            And the nextTaskstoBePerformed List of "${response}" is empty
                            and extract all ids from CPIB of "${relatedEntity_id}"
                            and Modification Netflix Standard and data bundle 100       ${relatedEntity_id}
    [Teardown]             Teardown Test Case