...
A package used in multiple other Order Management projects.
...
```bash
git clone git@gitlab.ow2.org:discobole/disco-oda-components/disco-order-management/order-commons.git
```
...
```bash
curl -s https://gitlab.ow2.org/api/v4/projects/discobole%2Fdisco-oda-components%2Fdisco-order-management%2Forder-commons | jq .id
```
