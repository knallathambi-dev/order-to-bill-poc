...
A Helm chart for product order inventory service.

## Source Code

* <https://gitlab.ow2.org/discobole/disco-oda-components/disco-order-management/order-inventory>
...
| mongo.architecture | string | `"standalone"` | architecture for MongoDB deployment. Can be standalone or replicaset. |
...
| services.adminUiUri | string | `"https://admin-ui"` | URI of the admin UI |
| services.authUserRole | string | `"auth-userrole"` | service name of the user role & permission API |
| services.hostModeUiUri | string | `"https://hostmode-ui"` | URI of the host mode UI |
| services.kafka | string | `"kafka"` |  |
| orderInventory.service.mxHeap | string | `""` | max heap memory for the order inventory service |
| services.orderInventoryUiUri | string | `"https://order-inventory-ui"` | URI of the order inventory UI |
| services.selfcareUiUri | string | `"https://selfcare-ui"` | URI of the selfcare UI |
