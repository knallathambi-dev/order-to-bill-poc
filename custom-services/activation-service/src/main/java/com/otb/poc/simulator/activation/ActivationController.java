...
public class ActivationController {
  private final ActivationSimulatorService simulatorService;
  private final ActivationRecordRepository repository;

  public ActivationController(ActivationSimulatorService simulatorService, ActivationRecordRepository repository) {
  ...
  public ResponseEntity<ActivationRecord> getOrder(@PathVariable String id) {
