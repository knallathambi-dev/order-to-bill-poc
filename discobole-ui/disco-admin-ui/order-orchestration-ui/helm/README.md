...
A Helm chart for order orchestration ui portal.

## Source Code

* <https://gitlab.ow2.org/discobole/disco-oda-components/disco-ui-portals/disco-microfrontend/order-orchestration-ui>
...
```bash
helm install my-release discobole-stable-repo/order-orchestration-ui
```
...
| orderorchestrationui.service.gatewayUrl | string | `"https://disco-gateway"` | gateway URL |
| orderorchestrationui.service.standaloneMode | bool | `false` | enable or disable standalone mode |
...
```console
$ helm install my-release -f values.yaml discobole-stable-repo/order-orchestration-ui
```
