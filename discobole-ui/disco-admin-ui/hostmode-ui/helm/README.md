...
A Helm chart for hostmode ui portal.

## Source Code

* <https://gitlab.ow2.org/discobole/disco-oda-components/disco-ui-portals/disco-microfrontend/hostmode-ui>
...
```bash
helm install my-release discobole-stable-repo/hostmode-ui
```
...
| hostmodeui.service.featureOrderManagement | bool | `true` | Enable the order management UI |
| hostmodeui.service.featureOrderOrchestration | bool | `true` | Enable the order orchestration UI |
| hostmodeui.service.featureProductInventory | bool | `true` | Enable the product inventory UI |
| hostmodeui.service.gatewayUrl | string | `"https://disco-gateway"` | gateway URL |
| hostmodeui.service.orderInventoryUiUrl | string | `"https://order-inventory-ui"` | URL of the order inventory UI |
| hostmodeui.service.orderOrchestrationUiUrl | string | `"https://product-inventory-ui"` | URL of the orchestration UI |
| hostmodeui.service.productInventoryUiUrl | string | `"https://order-orchestration-ui"` | URL of the product inventory UI |
...
| monitoring.domain | string | `""` | label to specify domain |
...
```console
$ helm install my-release -f values.yaml discobole-stable-repo/hostmode-ui
```
