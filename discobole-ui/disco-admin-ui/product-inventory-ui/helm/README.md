...
A Helm chart for product inventory ui portal.

## Source Code

* <https://gitlab.ow2.org/discobole/disco-oda-components/disco-ui-portals/disco-microfrontend/product-inventory-ui>
...
```bash
helm install my-release discobole-stable-repo/product-inventory-ui
```
...
| productinventoryui.service.gatewayUrl | string | `""` |  |
| productinventoryui.service.standaloneMode | bool | `false` |  |
...
```console
$ helm install my-release -f values.yaml discobole-stable-repo/product-inventory-ui
```
