...
A Helm chart for selfcare UI.

## Source Code

* <https://gitlab.ow2.org/discobole/disco-oda-components/disco-order-management/selfcare-ui>
...
```bash
helm install my-release discobole-stable-repo/selfcare-ui
```
...
| internalSecret | string | `""` | Internal secret |
| keycloak.adminPassword | string | `""` | administrator user password   |
| keycloak.adminUsername | string | `""` | administrator user name |
| keycloak.clientSecret | string | `""` |  |
| keycloak.password | string | `""` | Keycloak user password |
| keycloak.serviceClientId | string | `""` |  |
| keycloak.username | string | `""` | Keycloak user name |
...
| selfcareui.service.gateway | string | `""` | Gateway URI |
| selfcareui.service.keycloak | string | `""` | Keycloak URI |
| service.annotations | object | `{}` | enable monitoring and supervision of service |
| service.port | int | `8080` | Specify the port number for the service |
...
```console
$ helm install my-release -f values.yaml discobole-stable-repo/selfcare-ui
```
